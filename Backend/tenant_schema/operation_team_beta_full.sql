...
--
-- Host: 127.0.0.1    Database: otm_otm
-- ------------------------------------------------------
...
DROP TABLE IF EXISTS `account_sector`;
...
--
-- Table structure for table `account_vertical`
--

DROP TABLE IF EXISTS `account_vertical`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `account_vertical` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `unique_id` varchar(50) NOT NULL,
...
--
-- Table structure for table `amcrequired`
--

DROP TABLE IF EXISTS `amcrequired`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `amcrequired` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `bg_creation_main`
--

DROP TABLE IF EXISTS `bg_creation_main`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bg_creation_main` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `bg_creation_sub`
--

DROP TABLE IF EXISTS `bg_creation_sub`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bg_creation_sub` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `unique_id` varchar(200) NOT NULL,
  `bg_auto_id` varchar(200) NOT NULL,
  `form_main_unique_id` varchar(200) NOT NULL,
...
--
-- Table structure for table `bill_generation_summary`
--

DROP TABLE IF EXISTS `bill_generation_summary`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bill_generation_summary` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `bill_submission_form`
--

DROP TABLE IF EXISTS `bill_submission_form`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bill_submission_form` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `unique_id` varchar(50) NOT NULL,
...
--
-- Table structure for table `bill_submission_main_table`
--

DROP TABLE IF EXISTS `bill_submission_main_table`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bill_submission_main_table` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `unique_id` varchar(50) NOT NULL,
  `bill_form_main_unique_id` varchar(50) NOT NULL,
  `po_num` varchar(250) NOT NULL,
...
--
-- Table structure for table `bill_submission_pending_summary`
--

DROP TABLE IF EXISTS `bill_submission_pending_summary`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bill_submission_pending_summary` (
...
--
-- Table structure for table `bill_submission_sub`
--

DROP TABLE IF EXISTS `bill_submission_sub`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bill_submission_sub` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `bill_no` varchar(100) DEFAULT NULL,
...
--
-- Temporary table structure for view `bill_submitted_payment_pending`
--

DROP TABLE IF EXISTS `bill_submitted_payment_pending`;
/*!50001 DROP VIEW IF EXISTS `bill_submitted_payment_pending`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `bill_submitted_payment_pending` AS SELECT
 1 AS `bill_form_unique_id`,
  1 AS `acc_year`,
  1 AS `invoice_count`,
  1 AS `invoice_value` */;
...
--
-- Table structure for table `city_creation`
--

DROP TABLE IF EXISTS `city_creation`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `city_creation` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `unique_id` varchar(50) NOT NULL,
...
--
-- Table structure for table `consignee_creation`
--

DROP TABLE IF EXISTS `consignee_creation`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `consignee_creation` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `unique_id` varchar(50) NOT NULL,
...
--
-- Table structure for table `consignee_details_sub`
--

DROP TABLE IF EXISTS `consignee_details_sub`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `consignee_details_sub` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `copy_this_table`
--

DROP TABLE IF EXISTS `copy_this_table`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `copy_this_table` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `unique_id` varchar(50) NOT NULL,
  `is_active` int(11) NOT NULL DEFAULT 1,
  `is_delete` int(11) NOT NULL DEFAULT 0,
...
--
-- Table structure for table `courier_creation`
--

DROP TABLE IF EXISTS `courier_creation`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `courier_creation` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `unique_id` varchar(250) NOT NULL,
...
--
-- Table structure for table `dc_ir_doc_dispatch_details`
--

DROP TABLE IF EXISTS `dc_ir_doc_dispatch_details`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `dc_ir_doc_dispatch_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `unique_id` varchar(50) NOT NULL,
...
--
-- Table structure for table `dc_num_status`
--

DROP TABLE IF EXISTS `dc_num_status`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `dc_num_status` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `delivery_status_in_transit`
--

DROP TABLE IF EXISTS `delivery_status_in_transit`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `delivery_status_in_transit` (
  `acc_year` varchar(10) DEFAULT NULL,
  `po_count` int(11) DEFAULT NULL,
  `invoice_count` int(11) DEFAULT NULL,
...
DROP TABLE IF EXISTS `department_creation`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Table structure for table `department_creation_sublist`
--

DROP TABLE IF EXISTS `department_creation_sublist`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `department_creation_sublist` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `unique_id` varchar(250) NOT NULL,
...
--
-- Table structure for table `district_creation`
--

DROP TABLE IF EXISTS `district_creation`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `district_creation` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `unique_id` varchar(50) NOT NULL,
  `district_name` varchar(100) NOT NULL,
  `state_name` varchar(100) NOT NULL,
...
--
-- Table structure for table `document_verification_accounts`
--

DROP TABLE IF EXISTS `document_verification_accounts`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `document_verification_accounts` (
  `acc_year` varchar(10) NOT NULL,
  `po_count` int(11) DEFAULT NULL,
  `invoice_count` int(11) DEFAULT NULL,
  `invoice_value` decimal(10,2) DEFAULT NULL,
...
--
-- Table structure for table `engineer_name_creation`
--

DROP TABLE IF EXISTS `engineer_name_creation`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `engineer_name_creation` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `executive_creation`
--

DROP TABLE IF EXISTS `executive_creation`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `executive_creation` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `executive_name`
--

DROP TABLE IF EXISTS `executive_name`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `executive_name` (
...
--
-- Table structure for table `health_picme_followups_sub`
--

DROP TABLE IF EXISTS `health_picme_followups_sub`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `health_picme_followups_sub` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `unique_id` varchar(35) NOT NULL,
...
--
-- Table structure for table `installation_details_sublist`
--

DROP TABLE IF EXISTS `installation_details_sublist`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `installation_details_sublist` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `unique_id` varchar(50) DEFAULT NULL,
...
--
-- Table structure for table `installation_summary`
--
...
--
-- Table structure for table `insurence_type`
--

DROP TABLE IF EXISTS `insurence_type`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `insurence_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `unique_id` varchar(50) NOT NULL,
...
--
-- Table structure for table `invoice_creation`
--
...
--
-- Table structure for table `invoice_creation_26`
--

DROP TABLE IF EXISTS `invoice_creation_26`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `invoice_creation_26` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `unique_id` varchar(50) NOT NULL,
  `invoice_auto_id` varchar(100) NOT NULL,
  `po_unique_id` varchar(50) NOT NULL,
...
--
-- Table structure for table `invoice_creation_main`
--

DROP TABLE IF EXISTS `invoice_creation_main`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `invoice_creation_main` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `unique_id` varchar(50) NOT NULL,
  `form_main_unique_id` varchar(100) NOT NULL,
...
--
-- Table structure for table `invoice_creation_main_payment_data`
--

DROP TABLE IF EXISTS `invoice_creation_main_payment_data`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `invoice_creation_main_payment_data` (
  `id` int(11) NOT NULL,
  `unique_id` varchar(50) NOT NULL,
...
--
-- Table structure for table `invoice_sublist`
--

DROP TABLE IF EXISTS `invoice_sublist`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `invoice_sublist` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `unique_id` varchar(50) NOT NULL,
...
--
-- Table structure for table `invoice_sublist1`
--

DROP TABLE IF EXISTS `invoice_sublist1`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `invoice_sublist1` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `unique_id` varchar(50) NOT NULL,
  `invoice_id` varchar(100) DEFAULT NULL,
  `po_unique_id` varchar(50) DEFAULT NULL,
...
--
-- Table structure for table `invoice_summary_approved`
--

DROP TABLE IF EXISTS `invoice_summary_approved`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `invoice_summary_approved` (
  `acc_year` varchar(10) DEFAULT NULL,
  `po_count` int(11) DEFAULT NULL,
  `invoice_count` int(11) DEFAULT NULL,
  `invoice_value` decimal(10,2) DEFAULT NULL
...
--
-- Table structure for table `invoice_summary_pending_dispatch`
--

DROP TABLE IF EXISTS `invoice_summary_pending_dispatch`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `invoice_summary_pending_dispatch` (
  `acc_year` varchar(10) DEFAULT NULL,
  `po_count` int(11) DEFAULT NULL,
  `invoice_count` int(11) DEFAULT NULL,
  `invoice_value` decimal(10,2) DEFAULT NULL
...
--
-- Table structure for table `invoice_verfication_table`
--

DROP TABLE IF EXISTS `invoice_verfication_table`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `invoice_verfication_table` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `item_creation`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Table structure for table `item_creation_sub`
--

DROP TABLE IF EXISTS `item_creation_sub`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `item_creation_sub` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `unique_id` varchar(50) NOT NULL,
...
--
-- Table structure for table `item_schedule`
--
...
--
-- Table structure for table `master_productcategory`
--

DROP TABLE IF EXISTS `master_productcategory`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `master_productcategory` (
...
--
-- Table structure for table `material_qc`
--

DROP TABLE IF EXISTS `material_qc`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `material_qc` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `unique_id` varchar(50) DEFAULT NULL,
  `form_main_unique_id` varchar(100) NOT NULL,
...
--
-- Table structure for table `opera_doc_table`
--

DROP TABLE IF EXISTS `opera_doc_table`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `opera_doc_table` (
...
--
-- Table structure for table `opera_sign_table`
--

DROP TABLE IF EXISTS `opera_sign_table`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `opera_sign_table` (
  `acc_year` varchar(20) NOT NULL,
...
--
-- Table structure for table `payment_transaction_notification_reads`
--

DROP TABLE IF EXISTS `payment_transaction_notification_reads`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `payment_transaction_notification_reads` (
...
--
-- Table structure for table `payment_transaction_notifications`
--

DROP TABLE IF EXISTS `payment_transaction_notifications`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `payment_transaction_notifications` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `unique_id` varchar(50) NOT NULL,
...
--
-- Table structure for table `pincode_creation`
--

DROP TABLE IF EXISTS `pincode_creation`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `pincode_creation` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `unique_id` varchar(100) NOT NULL,
  `state_name` varchar(100) NOT NULL,
  `district_name` varchar(100) NOT NULL,
...
--
-- Table structure for table `po_combined_summary`
--

DROP TABLE IF EXISTS `po_combined_summary`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `po_combined_summary` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `acc_year` varchar(20) DEFAULT NULL,
  `po_count` int(11) DEFAULT 0,
...
--
-- Temporary table structure for view `po_consignee_assign`
--

DROP TABLE IF EXISTS `po_consignee_assign`;
/*!50001 DROP VIEW IF EXISTS `po_consignee_assign`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `po_consignee_assign` AS SELECT
 1 AS `po_number`,
  1 AS `form_main_unique_id`,
  1 AS `sess_user_type`,
  1 AS `stock_qty`,
  1 AS `total_invoice_qty`,
  1 AS `acc_year`,
  1 AS `stock_qty_value`,
  1 AS `invoice_qty_value`,
  1 AS `df`,
  1 AS `df_val` */;
SET character_set_client = @saved_cs_client;

--
-- Table structure for table `po_department_count`
--

DROP TABLE IF EXISTS `po_department_count`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `po_department_count` (
...
--
-- Table structure for table `po_form`
--

DROP TABLE IF EXISTS `po_form`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `po_form` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `unique_id` varchar(50) DEFAULT NULL,
  `po_unique_id` varchar(50) NOT NULL,
...
--
-- Table structure for table `po_form1`
--

DROP TABLE IF EXISTS `po_form1`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `po_form1` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `unique_id` varchar(50) DEFAULT NULL,
  `po_unique_id` varchar(50) NOT NULL,
  `po_num` varchar(250) NOT NULL,
...
--
-- Table structure for table `po_form_processed`
--

DROP TABLE IF EXISTS `po_form_processed`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `po_form_processed` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `po_product_assign_details`
--

DROP TABLE IF EXISTS `po_product_assign_details`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `po_product_assign_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `unique_id` varchar(50) DEFAULT NULL,
  `form_main_unique_id` varchar(100) NOT NULL,
...
--
-- Table structure for table `product_details_sub`
--

DROP TABLE IF EXISTS `product_details_sub`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `product_details_sub` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `unique_id` varchar(35) NOT NULL,
  `form_main_unique_id` varchar(100) DEFAULT NULL,
  `screen_unique_id` varchar(100) DEFAULT NULL,
...
--
-- Table structure for table `product_warrenty`
--

DROP TABLE IF EXISTS `product_warrenty`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `product_warrenty` (
  `s_no` int(11) NOT NULL AUTO_INCREMENT,
  `unique_id` varchar(50) NOT NULL,
...
--
-- Table structure for table `sign_doc_summary`
--

DROP TABLE IF EXISTS `sign_doc_summary`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sign_doc_summary` (
  `acc_year` varchar(10) NOT NULL,
  `po_count` int(11) DEFAULT NULL,
  `invoice_count` int(11) DEFAULT NULL,
  `invoice_value` decimal(15,2) DEFAULT NULL,
...
--
-- Table structure for table `sign_doc_verification_detail`
--

DROP TABLE IF EXISTS `sign_doc_verification_detail`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sign_doc_verification_detail` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `unique_id` varchar(50) NOT NULL,
  `form_main_unique_id` varchar(100) DEFAULT NULL,
  `po_num` varchar(250) NOT NULL,
...
--
-- Table structure for table `sign_doc_verification_detail_sublist`
--

DROP TABLE IF EXISTS `sign_doc_verification_detail_sublist`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sign_doc_verification_detail_sublist` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `unique_id` varchar(50) NOT NULL,
  `form_main_unique_id` varchar(100) DEFAULT NULL,
  `po_num` varchar(250) NOT NULL,
...
DROP TABLE IF EXISTS `state_creation`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Table structure for table `stock_assign_case_summary`
--

DROP TABLE IF EXISTS `stock_assign_case_summary`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `stock_assign_case_summary` (
...
--
-- Table structure for table `stock_invoice_summary`
--

DROP TABLE IF EXISTS `stock_invoice_summary`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `stock_invoice_summary` (
  `acc_year` varchar(10) DEFAULT NULL,
  `po_count` int(11) DEFAULT NULL,
...
--
-- Table structure for table `stock_position_main`
--

DROP TABLE IF EXISTS `stock_position_main`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `stock_position_main` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `unique_id` varchar(50) NOT NULL,
  `form_main_unique_id` varchar(100) NOT NULL,
  `batch_id` varchar(30) DEFAULT NULL,
...
--
-- Table structure for table `stock_position_sublist`
--

DROP TABLE IF EXISTS `stock_position_sublist`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `stock_position_sublist` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `unique_id` varchar(50) DEFAULT NULL,
  `form_main_unique_id` varchar(100) NOT NULL,
  `batch_id` varchar(30) DEFAULT NULL,
...
--
-- Table structure for table `team_allocation`
--

DROP TABLE IF EXISTS `team_allocation`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Table structure for table `tenant_branch`
--

DROP TABLE IF EXISTS `tenant_branch`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Table structure for table `unit_creation`
--

DROP TABLE IF EXISTS `unit_creation`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `unit_creation` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
) ENGINE=InnoDB AUTO_INCREMENT=214 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci AVG_ROW_LENGTH=910;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `user_screen_actions`
--

DROP TABLE IF EXISTS `user_screen_actions`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `user_screen_actions` (
  `s_no` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `user_screen_main`
--

DROP TABLE IF EXISTS `user_screen_main`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `user_screen_main` (
  `s_no` int(11) NOT NULL AUTO_INCREMENT,
  `unique_id` varchar(50) NOT NULL,
...
--
-- Table structure for table `user_screen_permission`
--

DROP TABLE IF EXISTS `user_screen_permission`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `user_screen_permission` (
  `s_no` int(11) NOT NULL AUTO_INCREMENT,
  `unique_id` varchar(50) NOT NULL,
...
--
-- Table structure for table `user_screen_sections`
--

DROP TABLE IF EXISTS `user_screen_sections`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `user_screen_sections` (
  `s_no` int(11) NOT NULL AUTO_INCREMENT,
  `unique_id` varchar(50) NOT NULL,
...
--
-- Table structure for table `user_screen_type`
--

DROP TABLE IF EXISTS `user_screen_type`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `user_screen_type` (
  `s_no` int(11) NOT NULL AUTO_INCREMENT,
  `unique_id` varchar(50) NOT NULL,
...
CREATE TABLE `user_type` (
  ...
  `sess_branch_id` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`s_no`)
) ENGINE=InnoDB AUTO_INCREMENT=54 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci AVG_ROW_LENGTH=1365;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Temporary table structure for view `v_po_status`
--

DROP TABLE IF EXISTS `v_po_status`;
/*!50001 DROP VIEW IF EXISTS `v_po_status`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `v_po_status` AS SELECT
 1 AS `unique_id`,
  1 AS `po_num`,
  1 AS `po_date`,
  1 AS `executive_name`,
  ...
  1 AS `file_name`,
  1 AS `conassignqty`,
  1 AS `2tabproductstatus`,
  1 AS `3tabconstatus`,
  1 AS `4thtabpoproductstatus`,
  1 AS `5tabpostatus` */;
SET character_set_client = @saved_cs_client;

--
-- Table structure for table `vendor_allocation`
--

DROP TABLE IF EXISTS `vendor_allocation`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Table structure for table `vendor_allocation_list`
--

DROP TABLE IF EXISTS `vendor_allocation_list`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `vendor_allocation_list` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `unique_id` varchar(50) NOT NULL,
  `po_num` varchar(250) NOT NULL,
  `po_unique_id` varchar(50) NOT NULL,
...
--
-- Table structure for table `vendor_allocation_sublist`
--

DROP TABLE IF EXISTS `vendor_allocation_sublist`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `vendor_allocation_sublist` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `unique_id` varchar(50) NOT NULL,
  `po_unique_id` varchar(50) NOT NULL,
  `dc_num` varchar(100) DEFAULT NULL,
...
--
-- Table structure for table `vendor_bill_creation`
--

DROP TABLE IF EXISTS `vendor_bill_creation`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `vendor_bill_creation` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `unique_id` varchar(50) NOT NULL,
  `name` varchar(150) NOT NULL,
  `is_active` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `vendor_creation`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Table structure for table `vendor_creation1`
--

DROP TABLE IF EXISTS `vendor_creation1`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `vendor_creation1` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `unique_id` varchar(50) NOT NULL,
  `company_name` varchar(255) NOT NULL,
  `name` varchar(255) NOT NULL,
...
--
-- Table structure for table `vendor_payment_count`
--

DROP TABLE IF EXISTS `vendor_payment_count`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `vendor_payment_count` (
  `acc_year` varchar(20) DEFAULT NULL,
...
--
-- Table structure for table `vendor_payment_details_main`
--

DROP TABLE IF EXISTS `vendor_payment_details_main`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `vendor_payment_details_main` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `unique_id` varchar(50) NOT NULL,
  `main_unique_id` varchar(50) NOT NULL,
...
--
-- Table structure for table `vendor_payment_main`
--

DROP TABLE IF EXISTS `vendor_payment_main`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `vendor_payment_main` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `unique_id` varchar(100) NOT NULL,
  `bill_no` varchar(100) NOT NULL,
...
--
-- Temporary table structure for view `view_ac_team_pending`
--

DROP TABLE IF EXISTS `view_ac_team_pending`;
/*!50001 DROP VIEW IF EXISTS `view_ac_team_pending`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_ac_team_pending` AS SELECT
 1 AS `po_unique_id`,
  1 AS `acc_year`,
  1 AS `sess_user_type`,
  1 AS `invoice_count`,
...
--
-- Temporary table structure for view `view_bg_list_final`
--

DROP TABLE IF EXISTS `view_bg_list_final`;
/*!50001 DROP VIEW IF EXISTS `view_bg_list_final`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_bg_list_final` AS SELECT
 1 AS `po_num`,
  1 AS `po_unique_id`,
  1 AS `form_main_unique_id`,
  1 AS `po_date`,
  ...
  1 AS `dc_number`,
  1 AS `dc_date`,
  1 AS `invoice_auto_id`,
  1 AS `executive_name`,
  1 AS `acc_year`,
  1 AS `consignee_unique_id`,
  1 AS `invoice_qty`,
  1 AS `invoice_value`,
  1 AS `bank_required`,
  1 AS `bg_percentage`,
  1 AS `bg_month`,
  1 AS `bg_status`,
  1 AS `po_product_name`,
  1 AS `with_bg`,
  1 AS `status_app` */;
SET character_set_client = @saved_cs_client;

--
-- Temporary table structure for view `view_bg_pending_count`
--

DROP TABLE IF EXISTS `view_bg_pending_count`;
/*!50001 DROP VIEW IF EXISTS `view_bg_pending_count`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_bg_pending_count` AS SELECT
 1 AS `form_main_unique_id`,
  1 AS `acc_year`,
  1 AS `invoice_count`,
  1 AS `invoice_value`,
...
--
-- Temporary table structure for view `view_bg_select_list1`
--

DROP TABLE IF EXISTS `view_bg_select_list1`;
/*!50001 DROP VIEW IF EXISTS `view_bg_select_list1`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_bg_select_list1` AS SELECT
 1 AS `po_num`,
  1 AS `po_unique_id`,
  1 AS `form_main_unique_id`,
  1 AS `po_date`,
...
--
-- Temporary table structure for view `view_bg_select_list2`
--

DROP TABLE IF EXISTS `view_bg_select_list2`;
/*!50001 DROP VIEW IF EXISTS `view_bg_select_list2`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_bg_select_list2` AS SELECT
 1 AS `form_main_unique_id`,
  1 AS `consignee_unique_id`,
  1 AS `invoice_no`,
  1 AS `acc_year`,
...
--
-- Temporary table structure for view `view_bill_pending_count`
--

DROP TABLE IF EXISTS `view_bill_pending_count`;
/*!50001 DROP VIEW IF EXISTS `view_bill_pending_count`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_bill_pending_count` AS SELECT
 1 AS `form_main_unique_id`,
  1 AS `invoice_count`,
  1 AS `invoice_no`,
  1 AS `acc_year`,
...
--
-- Temporary table structure for view `view_bill_submission_list_pending_1`
--

DROP TABLE IF EXISTS `view_bill_submission_list_pending_1`;
/*!50001 DROP VIEW IF EXISTS `view_bill_submission_list_pending_1`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_bill_submission_list_pending_1` AS SELECT
 1 AS `form_main_unique_id`,
  1 AS `invoice_no`,
  1 AS `invoice_date`,
  1 AS `invoice_value`,
  ...
  1 AS `dc_number`,
  1 AS `dc_date`,
  1 AS `con_contact_name`,
  1 AS `con_address`,
  1 AS `proced_without_bg`,
  1 AS `proced_with_bg`,
  1 AS `ins_unique_id`,
  1 AS `bill_status`,
  1 AS `ir_status`,
  1 AS `snr_status`,
  1 AS `bill_reject_reason`,
  1 AS `payment_cancel_reason`,
  1 AS `file_name`,
  1 AS `department`,
  1 AS `file_org_name`,
  1 AS `ins_reqired`,
...
--
-- Temporary table structure for view `view_bill_submission_main_table`
--

DROP TABLE IF EXISTS `view_bill_submission_main_table`;
/*!50001 DROP VIEW IF EXISTS `view_bill_submission_main_table`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_bill_submission_main_table` AS SELECT
 1 AS `id`,
  1 AS `unique_id`,
  1 AS `bill_form_main_unique_id`,
  1 AS `po_num`,
  1 AS `po_date`,
  1 AS `con_contact_name`,
  1 AS `con_address`,
  ...
  1 AS `claim_amount`,
  1 AS `claimamt`,
  1 AS `bill_submission_date`,
  1 AS `e_no`,
  1 AS `elcot_ent_status`,
  1 AS `bill_status`,
  1 AS `bill_no`,
  1 AS `payment_date`,
  1 AS `payment_status`,
  1 AS `payement_receive`,
  1 AS `status`,
  1 AS `file_name`,
  1 AS `file_org_name`,
  1 AS `ld_amount`,
  1 AS `ld_days`,
  1 AS `is_delete`,
  1 AS `bill_created_date`,
  1 AS `partial_bill_status`,
  1 AS `acc_year`,
  1 AS `is_active`,
  1 AS `created`,
  1 AS `updated`,
  ...
  1 AS `sess_user_type`,
  1 AS `sess_user_id`,
  1 AS `sess_company_id`,
  1 AS `sess_branch_id` */;
SET character_set_client = @saved_cs_client;

--
-- Temporary table structure for view `view_bill_submission_otm_without_bg`
--

DROP TABLE IF EXISTS `view_bill_submission_otm_without_bg`;
/*!50001 DROP VIEW IF EXISTS `view_bill_submission_otm_without_bg`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_bill_submission_otm_without_bg` AS SELECT
 1 AS `form_main_unique_id`,
  1 AS `po_num`,
  1 AS `po_date`,
  1 AS `invoice_no`,
...
--
-- Temporary table structure for view `view_bill_submission_sub_table`
--

DROP TABLE IF EXISTS `view_bill_submission_sub_table`;
/*!50001 DROP VIEW IF EXISTS `view_bill_submission_sub_table`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_bill_submission_sub_table` AS SELECT
 1 AS `id`,
  1 AS `unique_id`,
  1 AS `bill_form_unique_id`,
  1 AS `po_num`,
...
--
-- Temporary table structure for view `view_bill_submission_with_bg`
--

DROP TABLE IF EXISTS `view_bill_submission_with_bg`;
/*!50001 DROP VIEW IF EXISTS `view_bill_submission_with_bg`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_bill_submission_with_bg` AS SELECT
 1 AS `form_main_unique_id`,
  1 AS `po_num`,
  1 AS `po_date`,
  1 AS `invoice_no`,
...
--
-- Temporary table structure for view `view_bill_submission_without_bg`
--

DROP TABLE IF EXISTS `view_bill_submission_without_bg`;
/*!50001 DROP VIEW IF EXISTS `view_bill_submission_without_bg`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_bill_submission_without_bg` AS SELECT
 1 AS `form_main_unique_id`,
  1 AS `po_num`,
  1 AS `po_date`,
  1 AS `con_contact_name`,
  ...
  1 AS `bill_status`,
  1 AS `claim_amount`,
  1 AS `scanned_dc_copy`,
  1 AS `scanned_snr_copy`,
  1 AS `scanned_ir_copy`,
  1 AS `invoice_copy`,
  1 AS `installation_reference_no`,
...
--
-- Temporary table structure for view `view_consignee_product_details`
--

DROP TABLE IF EXISTS `view_consignee_product_details`;
/*!50001 DROP VIEW IF EXISTS `view_consignee_product_details`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_consignee_product_details` AS SELECT
 1 AS `main_unique_id`,
  1 AS `product_unique_id`,
  1 AS `item_code`,
  1 AS `product_name`,
  1 AS `qty`,
  1 AS `unit_price`,
...
--
-- Temporary table structure for view `view_dash_stock_position`
--

DROP TABLE IF EXISTS `view_dash_stock_position`;
/*!50001 DROP VIEW IF EXISTS `view_dash_stock_position`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_dash_stock_position` AS SELECT
 1 AS `unique_id`,
  1 AS `total_qty`,
  1 AS `total_amount`,
  1 AS `sess_user_type`,
...
--
-- Temporary table structure for view `view_deleievery_confirmation_complete`
--

DROP TABLE IF EXISTS `view_deleievery_confirmation_complete`;
/*!50001 DROP VIEW IF EXISTS `view_deleievery_confirmation_complete`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_deleievery_confirmation_complete` AS SELECT
 1 AS `unique_id`,
  1 AS `po_num`,
  1 AS `po_date`,
  1 AS `po_form_unique_id`,
  1 AS `invoice_auto_id`,
  1 AS `invoice_no`,
  1 AS `invoice_value`,
  1 AS `ledger_name`,
  ...
  1 AS `delivery_date`,
  1 AS `delivery_proof`,
  1 AS `name_of_courier`,
  1 AS `delv_conf_person`,
  1 AS `delv_conf_date`,
  1 AS `mode_of_delivery`,
  1 AS `status`,
  1 AS `consignee_unique_id`,
  1 AS `department` */;
SET character_set_client = @saved_cs_client;
...
--
-- Temporary table structure for view `view_deleievery_confirmation_pending`
--

DROP TABLE IF EXISTS `view_deleievery_confirmation_pending`;
/*!50001 DROP VIEW IF EXISTS `view_deleievery_confirmation_pending`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_deleievery_confirmation_pending` AS SELECT
 1 AS `unique_id`,
  1 AS `po_num`,
  1 AS `po_date`,
  1 AS `po_form_unique_id`,
...
--
-- Temporary table structure for view `view_delivery_confirmation`
--

DROP TABLE IF EXISTS `view_delivery_confirmation`;
/*!50001 DROP VIEW IF EXISTS `view_delivery_confirmation`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_delivery_confirmation` AS SELECT
 1 AS `unique_id`,
  1 AS `po_num`,
  1 AS `po_date`,
  1 AS `po_form_unique_id`,
...
--
-- Temporary table structure for view `view_dispatch_complete_count`
--

DROP TABLE IF EXISTS `view_dispatch_complete_count`;
/*!50001 DROP VIEW IF EXISTS `view_dispatch_complete_count`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_dispatch_complete_count` AS SELECT
 1 AS `form_main_unique_id`,
  1 AS `acc_year`,
  1 AS `invoice_no`,
  1 AS `sess_user_type`,
...
--
-- Temporary table structure for view `view_dispatch_completed_list`
--

DROP TABLE IF EXISTS `view_dispatch_completed_list`;
/*!50001 DROP VIEW IF EXISTS `view_dispatch_completed_list`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_dispatch_completed_list` AS SELECT
 1 AS `form_main_unique_id`,
  1 AS `invoice_auto_id`,
  1 AS `po_num`,
  1 AS `po_date`,
  1 AS `invoice_no`,
  1 AS `team_alloc_eng_type`,
  1 AS `team_alloc_eng_name`,
  1 AS `invoice_date`,
  1 AS `invoice_value`,
  1 AS `invoice_qty`,
  1 AS `dc_number`,
  ...
  1 AS `unique_id`,
  1 AS `stock_id`,
  1 AS `ac_team_approved_by`,
  1 AS `approved_by`,
  1 AS `material_qc`,
  1 AS `material_qc_approved`,
  1 AS `doc_approval_sts`,
  1 AS `inv_dispatch_status`,
  1 AS `ac_team_verifiy_status`,
  1 AS `consignee_unique_id`,
  1 AS `is_delete`,
  1 AS `ledger_name`,
  1 AS `vendor_bulk_sts`,
  1 AS `vendor_team_sts`,
  1 AS `file_name`,
  1 AS `bill_address`,
  1 AS `dc_file_name`,
  1 AS `file_org_name`,
  1 AS `ir_file_name`,
  1 AS `ir_file_org_name`,
  1 AS `file_invoice`,
  1 AS `invoice_file_org_name`,
  1 AS `department`,
  1 AS `dispatch_status` */;
SET character_set_client = @saved_cs_client;

--
-- Temporary table structure for view `view_dispatch_delivery_list`
--

DROP TABLE IF EXISTS `view_dispatch_delivery_list`;
/*!50001 DROP VIEW IF EXISTS `view_dispatch_delivery_list`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_dispatch_delivery_list` AS SELECT
 1 AS `unique_id`,
  1 AS `po_num`,
  1 AS `po_date`,
  1 AS `po_form_unique_id`,
...
--
-- Temporary table structure for view `view_dispatch_delivery_list_2`
--

DROP TABLE IF EXISTS `view_dispatch_delivery_list_2`;
/*!50001 DROP VIEW IF EXISTS `view_dispatch_delivery_list_2`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_dispatch_delivery_list_2` AS SELECT
 1 AS `unique_id`,
  1 AS `po_num`,
  1 AS `po_date`,
  1 AS `po_form_unique_id`,
...
--
-- Temporary table structure for view `view_dispatch_list_final`
--

DROP TABLE IF EXISTS `view_dispatch_list_final`;
/*!50001 DROP VIEW IF EXISTS `view_dispatch_list_final`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_dispatch_list_final` AS SELECT
 1 AS `po_num`,
  1 AS `po_date`,
  1 AS `unique_id`,
  1 AS `is_delete`,
...
--
-- Temporary table structure for view `view_dispatch_pending_count`
--

DROP TABLE IF EXISTS `view_dispatch_pending_count`;
/*!50001 DROP VIEW IF EXISTS `view_dispatch_pending_count`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_dispatch_pending_count` AS SELECT
 1 AS `form_main_unique_id`,
  1 AS `acc_year`,
  1 AS `sess_user_type`,
  1 AS `invoice_count`,
...
--
-- Temporary table structure for view `view_dispatch_pending_list`
--

DROP TABLE IF EXISTS `view_dispatch_pending_list`;
/*!50001 DROP VIEW IF EXISTS `view_dispatch_pending_list`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_dispatch_pending_list` AS SELECT
 1 AS `form_main_unique_id`,
  1 AS `invoice_auto_id`,
  1 AS `po_num`,
  1 AS `po_date`,
...
--
-- Temporary table structure for view `view_dispatch_transit_list`
--

DROP TABLE IF EXISTS `view_dispatch_transit_list`;
/*!50001 DROP VIEW IF EXISTS `view_dispatch_transit_list`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_dispatch_transit_list` AS SELECT
 1 AS `unique_id`,
  1 AS `po_num`,
  1 AS `po_date`,
  1 AS `po_form_unique_id`,
...
--
-- Temporary table structure for view `view_doc_approval_list1`
--

DROP TABLE IF EXISTS `view_doc_approval_list1`;
/*!50001 DROP VIEW IF EXISTS `view_doc_approval_list1`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_doc_approval_list1` AS SELECT
 1 AS `po_num`,
  1 AS `po_date`,
  1 AS `consignee_unique_id`,
  1 AS `invoice_unique_id`,
  1 AS `invoice_auto_id`,
  1 AS `form_main_unique_id`,
  1 AS `executive_name`,
  1 AS `invoice_no`,
  ...
  1 AS `material_qc`,
  1 AS `material_qc_approved`,
  1 AS `material_qc_reject_reason`,
  1 AS `dc_number`,
  1 AS `dc_date`,
  1 AS `team_mem`,
  1 AS `dc_file_name`,
...
--
-- Temporary table structure for view `view_doc_approval_list2`
--

DROP TABLE IF EXISTS `view_doc_approval_list2`;
/*!50001 DROP VIEW IF EXISTS `view_doc_approval_list2`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_doc_approval_list2` AS SELECT
 1 AS `form_main_unique_id`,
  1 AS `invoice_no`,
  1 AS `consignee_unique_id`,
  1 AS `po_unique_id`,
...
--
-- Temporary table structure for view `view_doc_approval_list_final`
--

DROP TABLE IF EXISTS `view_doc_approval_list_final`;
/*!50001 DROP VIEW IF EXISTS `view_doc_approval_list_final`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_doc_approval_list_final` AS SELECT
 1 AS `dc_number`,
  1 AS `dc_date`,
  1 AS `po_num`,
  1 AS `po_date`,
...
--
-- Temporary table structure for view `view_doc_approval_list_final_ac_team`
--

DROP TABLE IF EXISTS `view_doc_approval_list_final_ac_team`;
/*!50001 DROP VIEW IF EXISTS `view_doc_approval_list_final_ac_team`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_doc_approval_list_final_ac_team` AS SELECT
 1 AS `dc_number`,
  1 AS `dc_date`,
  1 AS `po_num`,
  1 AS `po_date`,
...
--
-- Temporary table structure for view `view_document_engineer_count_1`
--

DROP TABLE IF EXISTS `view_document_engineer_count_1`;
/*!50001 DROP VIEW IF EXISTS `view_document_engineer_count_1`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_document_engineer_count_1` AS SELECT
 1 AS `form_main_unique_id`,
  1 AS `acc_year`,
  1 AS `sess_user_type`,
  1 AS `invoice_count`,
...
--
-- Temporary table structure for view `view_document_pending_count`
--

DROP TABLE IF EXISTS `view_document_pending_count`;
/*!50001 DROP VIEW IF EXISTS `view_document_pending_count`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_document_pending_count` AS SELECT
 1 AS `po_form_unique_id`,
  1 AS `invoice_no`,
  1 AS `acc_year`,
  1 AS `sess_user_type`,
...
--
-- Temporary table structure for view `view_elcot_entry_final_bill_list`
--

DROP TABLE IF EXISTS `view_elcot_entry_final_bill_list`;
/*!50001 DROP VIEW IF EXISTS `view_elcot_entry_final_bill_list`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_elcot_entry_final_bill_list` AS SELECT
 1 AS `unique_id`,
  1 AS `po_num`,
  1 AS `po_date`,
  1 AS `invoice_no`,
...
--
-- Temporary table structure for view `view_elcot_pending`
--

DROP TABLE IF EXISTS `view_elcot_pending`;
/*!50001 DROP VIEW IF EXISTS `view_elcot_pending`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_elcot_pending` AS SELECT
 1 AS `po_unique_id`,
  1 AS `acc_year`,
  1 AS `invoice_no`,
  1 AS `sess_user_type`,
...
--
-- Temporary table structure for view `view_entry_form`
--

DROP TABLE IF EXISTS `view_entry_form`;
/*!50001 DROP VIEW IF EXISTS `view_entry_form`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_entry_form` AS SELECT
 1 AS `po_count`,
  1 AS `invoice_count`,
  1 AS `dc_count`,
  1 AS `acc_year`,
...
--
-- Temporary table structure for view `view_installation_followups`
--

DROP TABLE IF EXISTS `view_installation_followups`;
/*!50001 DROP VIEW IF EXISTS `view_installation_followups`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_installation_followups` AS SELECT
 1 AS `form_main_unique_id`,
  1 AS `po_unique_id`,
  1 AS `po_num`,
  1 AS `po_date`,
  ...
  1 AS `invoice_date`,
  1 AS `invoice_value`,
  1 AS `installation_com_date`,
  1 AS `installation_status`,
  1 AS `engg_type`,
  1 AS `engineer_name`,
  1 AS `vendor_bulk_status`,
  1 AS `bulk_eng_type`,
  1 AS `bulk_eng_name`,
  1 AS `vendor_ins_date`,
  1 AS `ven_assign_no`,
  1 AS `ven_assign_date`,
  1 AS `vendor_bulk_timeline`,
  1 AS `bulk_total_amount`,
  1 AS `date`,
  1 AS `in_charge`,
  1 AS `eng_remarks`,
  1 AS `dispatch_status`,
  ...
  1 AS `ledger_name`,
  1 AS `sess_user_type`,
  1 AS `sign_reject_reason`,
  1 AS `team_mem`,
  1 AS `con_address`,
  1 AS `con_district_unique_id`,
  1 AS `con_district`,
  1 AS `con_state_name_unique_id`,
  1 AS `con_state_name`,
  1 AS `zone`,
  1 AS `con_pincode`,
  1 AS `con_contact_name`,
  ...
  1 AS `po_file_name`,
  1 AS `department`,
  1 AS `po_file_org_name`,
  1 AS `delivery_due_dates`,
  1 AS `status`,
  1 AS `invoice_no`,
  1 AS `document_required`,
  1 AS `ins_reqired`,
  1 AS `dc_required`,
  1 AS `insurance_required`,
  1 AS `ld_required` */;
SET character_set_client = @saved_cs_client;

--
-- Temporary table structure for view `view_installation_followups1`
--

DROP TABLE IF EXISTS `view_installation_followups1`;
/*!50001 DROP VIEW IF EXISTS `view_installation_followups1`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_installation_followups1` AS SELECT
 1 AS `unique_id`,
  1 AS `form_main_unique_id`,
  1 AS `po_unique_id`,
  1 AS `po_num`,
  ...
  1 AS `documents_type`,
  1 AS `engineer_name`,
  1 AS `documents_type1`,
  1 AS `documents_type2`,
  1 AS `dc_delivery_status`,
  1 AS `dc_required`,
  1 AS `dc_number`,
  1 AS `doc_appload_person`,
  1 AS `ins_reqired` */;
SET character_set_client = @saved_cs_client;

--
-- Temporary table structure for view `view_invoice_assign_qty_count`
--

DROP TABLE IF EXISTS `view_invoice_assign_qty_count`;
/*!50001 DROP VIEW IF EXISTS `view_invoice_assign_qty_count`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_invoice_assign_qty_count` AS SELECT
 1 AS `acc_year`,
  1 AS `form_main_unique_id`,
  1 AS `stk_qty`,
  1 AS `inv_qty`,
...
--
-- Temporary table structure for view `view_invoice_completed_count_value`
--

DROP TABLE IF EXISTS `view_invoice_completed_count_value`;
/*!50001 DROP VIEW IF EXISTS `view_invoice_completed_count_value`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_invoice_completed_count_value` AS SELECT
 1 AS `po_count`,
  1 AS `acc_year`,
  1 AS `sess_user_type`,
  1 AS `invoice_count`,
...
--
-- Temporary table structure for view `view_ld_value_count`
--

DROP TABLE IF EXISTS `view_ld_value_count`;
/*!50001 DROP VIEW IF EXISTS `view_ld_value_count`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_ld_value_count` AS SELECT
 1 AS `bill_form_unique_id`,
  1 AS `acc_year`,
  1 AS `invoice_count`,
  1 AS `ld_value` */;
...
--
-- Temporary table structure for view `view_mismatch_data`
--

DROP TABLE IF EXISTS `view_mismatch_data`;
/*!50001 DROP VIEW IF EXISTS `view_mismatch_data`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_mismatch_data` AS SELECT
 1 AS `po_num`,
  1 AS `po_date`,
  1 AS `ledger_name`,
  1 AS `team_member`,
  ...
  1 AS `dc_file`,
  1 AS `ir_file`,
  1 AS `document_verification_status`,
  1 AS `sign_reject_reason`,
  1 AS `consignee_unique_id`,
  1 AS `po_form_unique_id`,
  1 AS `ins_unique_id`,
...
--
-- Temporary table structure for view `view_mismatch_installation`
--

DROP TABLE IF EXISTS `view_mismatch_installation`;
/*!50001 DROP VIEW IF EXISTS `view_mismatch_installation`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_mismatch_installation` AS SELECT
 1 AS `form_main_unique_id`,
  1 AS `po_unique_id`,
  1 AS `po_num`,
  1 AS `po_date`,
  ...
  1 AS `snr_status`,
  1 AS `dc_file`,
  1 AS `dc_original_name`,
  1 AS `dc_cus_signed_date`,
  1 AS `ir_file`,
  1 AS `ir_original_name`,
  1 AS `ir_cus_signed_date`,
  1 AS `snr_file`,
  1 AS `acc_year`,
  1 AS `snr_original_name`,
  1 AS `snr_cus_signed_date`,
  1 AS `dc_ir_status`,
  1 AS `dc_dispatch_mode`,
  1 AS `ir_dispatch_mode`,
  1 AS `snr_dispatch_mode`,
  1 AS `po_file`,
  1 AS `department`,
  1 AS `po_file_org_name`,
  1 AS `dc_required`,
...
--
-- Temporary table structure for view `view_ops_bill_submission_without_bg`
--

DROP TABLE IF EXISTS `view_ops_bill_submission_without_bg`;
/*!50001 DROP VIEW IF EXISTS `view_ops_bill_submission_without_bg`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_ops_bill_submission_without_bg` AS SELECT
 1 AS `form_main_unique_id`,
  1 AS `po_num`,
  1 AS `po_date`,
  1 AS `con_contact_name`,
...
--
-- Temporary table structure for view `view_otm_bill_pending_list`
--

DROP TABLE IF EXISTS `view_otm_bill_pending_list`;
/*!50001 DROP VIEW IF EXISTS `view_otm_bill_pending_list`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_otm_bill_pending_list` AS SELECT
 1 AS `unique_id`,
  1 AS `po_num`,
  1 AS `po_date`,
  1 AS `invoice_no`,
...
--
-- Temporary table structure for view `view_otm_with_bg_pendinglist1`
--

DROP TABLE IF EXISTS `view_otm_with_bg_pendinglist1`;
/*!50001 DROP VIEW IF EXISTS `view_otm_with_bg_pendinglist1`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_otm_with_bg_pendinglist1` AS SELECT
 1 AS `form_main_unique_id`,
  1 AS `po_num`,
  1 AS `po_date`,
  1 AS `invoice_no`,
...
--
-- Temporary table structure for view `view_otm_withoutbg_peding2list`
--

DROP TABLE IF EXISTS `view_otm_withoutbg_peding2list`;
/*!50001 DROP VIEW IF EXISTS `view_otm_withoutbg_peding2list`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_otm_withoutbg_peding2list` AS SELECT
 1 AS `form_main_unique_id`,
  1 AS `po_num`,
  1 AS `po_date`,
  1 AS `invoice_no`,
...
--
-- Temporary table structure for view `view_outsource_vendor_verified_invoice`
--

DROP TABLE IF EXISTS `view_outsource_vendor_verified_invoice`;
/*!50001 DROP VIEW IF EXISTS `view_outsource_vendor_verified_invoice`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_outsource_vendor_verified_invoice` AS SELECT
 1 AS `unique_id`,
  1 AS `invoice_no`,
  1 AS `invoice_date`,
  1 AS `dc_number`,
  ...
  1 AS `bulk_eng_type`,
  1 AS `bulk_eng_name`,
  1 AS `vendor_payment_allocated`,
  1 AS `vendor_finance_approval`,
  1 AS `outsrc_eng_name`,
  1 AS `engineer_name`,
  1 AS `bulk_total_amount`,
  1 AS `bulk_dc_total_amount`,
  1 AS `vendor_bulk_rate`,
  1 AS `vendor_bulk_sts`,
  1 AS `vendor_bulk_gst`,
  1 AS `vendor_bulk_timeline`,
  1 AS `vendor_inst_allocation_date`,
  1 AS `inv_verify_status`,
  1 AS `inv_verify_approvedby`,
  1 AS `inv_verify_approved_date`,
  1 AS `vendor_inv_attach_approval`,
  1 AS `veninvstatus`,
  1 AS `vendor_bill_app_status`,
  1 AS `vendor_bill_reject_reason`,
  1 AS `vendor_bill_rejected_by`,
  1 AS `vendor_bill_approval_allocated`,
  1 AS `document_verification_status`,
  1 AS `dc_required`,
  1 AS `signed_complete_status` */;
SET character_set_client = @saved_cs_client;

--
-- Temporary table structure for view `view_partial_bill_1`
--

DROP TABLE IF EXISTS `view_partial_bill_1`;
/*!50001 DROP VIEW IF EXISTS `view_partial_bill_1`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_partial_bill_1` AS SELECT
 1 AS `bill_form_unique_id`,
  1 AS `po_num`,
  1 AS `po_date`,
  1 AS `invoice_no`,
  ...
  1 AS `warranty`,
  1 AS `claim_amount`,
  1 AS `claim_ttl_amount` */;
SET character_set_client = @saved_cs_client;

--
-- Temporary table structure for view `view_partial_bill_submission_with_bg`
--

DROP TABLE IF EXISTS `view_partial_bill_submission_with_bg`;
/*!50001 DROP VIEW IF EXISTS `view_partial_bill_submission_with_bg`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_partial_bill_submission_with_bg` AS SELECT
 1 AS `bill_form_main_unique_id`,
  1 AS `po_num`,
  1 AS `po_date`,
  1 AS `invoice_no`,
...
--
-- Temporary table structure for view `view_partial_bill_submission_without_bg`
--

DROP TABLE IF EXISTS `view_partial_bill_submission_without_bg`;
/*!50001 DROP VIEW IF EXISTS `view_partial_bill_submission_without_bg`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_partial_bill_submission_without_bg` AS SELECT
 1 AS `bill_form_main_unique_id`,
  1 AS `po_num`,
  1 AS `po_date`,
  1 AS `invoice_no`,
...
--
-- Temporary table structure for view `view_partial_elcot_entry_final`
--

DROP TABLE IF EXISTS `view_partial_elcot_entry_final`;
/*!50001 DROP VIEW IF EXISTS `view_partial_elcot_entry_final`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_partial_elcot_entry_final` AS SELECT
 1 AS `unique_id`,
  1 AS `po_num`,
  1 AS `po_date`,
  1 AS `invoice_no`,
...
--
-- Temporary table structure for view `view_payment_entry_list`
--

DROP TABLE IF EXISTS `view_payment_entry_list`;
/*!50001 DROP VIEW IF EXISTS `view_payment_entry_list`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_payment_entry_list` AS SELECT
 1 AS `bill_form_unique_id`,
  1 AS `invoice_no`,
  1 AS `invoice_date`,
  1 AS `invoice_value`,
...
--
-- Temporary table structure for view `view_payment_partial`
--

DROP TABLE IF EXISTS `view_payment_partial`;
/*!50001 DROP VIEW IF EXISTS `view_payment_partial`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_payment_partial` AS SELECT
 1 AS `bill_form_unique_id`,
  1 AS `invoice_no`,
  1 AS `invoice_date`,
  1 AS `invoice_value`,
...
--
-- Temporary table structure for view `view_payment_received_count`
--

DROP TABLE IF EXISTS `view_payment_received_count`;
/*!50001 DROP VIEW IF EXISTS `view_payment_received_count`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_payment_received_count` AS SELECT
 1 AS `bill_form_unique_id`,
  1 AS `acc_year`,
  1 AS `invoice_count`,
  1 AS `invoice_value` */;
...
--
-- Temporary table structure for view `view_pending_invoice_count_value`
--

DROP TABLE IF EXISTS `view_pending_invoice_count_value`;
/*!50001 DROP VIEW IF EXISTS `view_pending_invoice_count_value`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_pending_invoice_count_value` AS SELECT
 1 AS `po_num`,
  1 AS `po_count`,
  1 AS `invoice_no`,
  1 AS `acc_year`,
...
--
-- Temporary table structure for view `view_po_consignee_deatail`
--

DROP TABLE IF EXISTS `view_po_consignee_deatail`;
/*!50001 DROP VIEW IF EXISTS `view_po_consignee_deatail`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_po_consignee_deatail` AS SELECT
 1 AS `main_unique_id`,
  1 AS `po_unique_id`,
  1 AS `con_unique_id`,
  1 AS `con_address`,
  ...
  1 AS `zone`,
  1 AS `batch_id`,
  1 AS `batch_entry_date`,
  1 AS `po_number`,
  1 AS `is_delete` */;
SET character_set_client = @saved_cs_client;

--
-- Temporary table structure for view `view_po_consignee_deatail1`
--

DROP TABLE IF EXISTS `view_po_consignee_deatail1`;
/*!50001 DROP VIEW IF EXISTS `view_po_consignee_deatail1`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_po_consignee_deatail1` AS SELECT
 1 AS `main_unique_id`,
  1 AS `po_unique_id`,
  1 AS `con_unique_id`,
  1 AS `con_address`,
...
--
-- Temporary table structure for view `view_po_count_value`
--

DROP TABLE IF EXISTS `view_po_count_value`;
/*!50001 DROP VIEW IF EXISTS `view_po_count_value`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_po_count_value` AS SELECT
 1 AS `unique_id`,
  1 AS `acc_year`,
  1 AS `po_num`,
  1 AS `count`,
...
--
-- Temporary table structure for view `view_po_form_list`
--

DROP TABLE IF EXISTS `view_po_form_list`;
/*!50001 DROP VIEW IF EXISTS `view_po_form_list`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_po_form_list` AS SELECT
 1 AS `id`,
  1 AS `unique_id`,
  1 AS `type_of_po`,
  1 AS `po_num`,
...
--
-- Temporary table structure for view `view_po_ledger_list`
--

DROP TABLE IF EXISTS `view_po_ledger_list`;
/*!50001 DROP VIEW IF EXISTS `view_po_ledger_list`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_po_ledger_list` AS SELECT
 1 AS `department`,
  1 AS `department_unique_id`,
  1 AS `ledger_name`,
  1 AS `ledger_no`,
  1 AS `unique_id` */;
SET character_set_client = @saved_cs_client;
...
--
-- Temporary table structure for view `view_po_product_deatail`
--

DROP TABLE IF EXISTS `view_po_product_deatail`;
/*!50001 DROP VIEW IF EXISTS `view_po_product_deatail`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_po_product_deatail` AS SELECT
 1 AS `main_unique_id`,
  1 AS `po_unique_id`,
  1 AS `product_unique_id`,
  1 AS `item_code`,
...
--
-- Temporary table structure for view `view_po_wise_list`
--

DROP TABLE IF EXISTS `view_po_wise_list`;
/*!50001 DROP VIEW IF EXISTS `view_po_wise_list`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_po_wise_list` AS SELECT
 1 AS `po_unique_id`,
  1 AS `po_num`,
  1 AS `po_date`,
  1 AS `department`,
  ...
  1 AS `con_name`,
  1 AS `warranty_duration`,
  1 AS `cons_billing_address`,
  1 AS `con_branch`,
  1 AS `con_branch_code`,
  1 AS `con_address`,
  1 AS `con_district`,
  1 AS `con_state`,
  1 AS `con_pincode`,
  ...
  1 AS `con_lan_num`,
  1 AS `contact_name`,
  1 AS `alter_contact_name`,
  1 AS `cons_followed_by`,
  1 AS `alter_number`,
  1 AS `cons_email_id`,
  1 AS `consignee_received_date`,
  1 AS `consignee_gst`,
  1 AS `consignee_batch_date`,
  1 AS `billing_gst_no`,
  1 AS `region`,
  1 AS `con_assign_team_member`,
  1 AS `item_code`,
  1 AS `product`,
  1 AS `qty`,
  1 AS `assign_qty`,
...
--
-- Temporary table structure for view `view_product_assign_con_details`
--

DROP TABLE IF EXISTS `view_product_assign_con_details`;
/*!50001 DROP VIEW IF EXISTS `view_product_assign_con_details`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_product_assign_con_details` AS SELECT
 1 AS `form_main_unique_id`,
  1 AS `con_unique_id`,
  1 AS `con_address`,
...
--
-- Temporary table structure for view `view_product_details_list`
--

DROP TABLE IF EXISTS `view_product_details_list`;
/*!50001 DROP VIEW IF EXISTS `view_product_details_list`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_product_details_list` AS SELECT
 1 AS `id`,
  1 AS `unique_id`,
  1 AS `form_main_unique_id`,
  1 AS `no_of_items`,
...
--
-- Temporary table structure for view `view_pur_stock_pending_count`
--

DROP TABLE IF EXISTS `view_pur_stock_pending_count`;
/*!50001 DROP VIEW IF EXISTS `view_pur_stock_pending_count`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_pur_stock_pending_count` AS SELECT
 1 AS `acc_year`,
  1 AS `status`,
  1 AS `po_count1`,
  1 AS `value1` */;
...
--
-- Temporary table structure for view `view_report_on_customer`
--

DROP TABLE IF EXISTS `view_report_on_customer`;
/*!50001 DROP VIEW IF EXISTS `view_report_on_customer`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_report_on_customer` AS SELECT
 1 AS `unique_id`,
  1 AS `po_date`,
  1 AS `executive_name`,
  1 AS `department`,
  ...
  1 AS `no_of_consignee`,
  1 AS `total_qty`,
  1 AS `with_tax_amount`,
  1 AS `without_tax_amount` */;
SET character_set_client = @saved_cs_client;

--
-- Temporary table structure for view `view_report_on_excutive`
--

DROP TABLE IF EXISTS `view_report_on_excutive`;
/*!50001 DROP VIEW IF EXISTS `view_report_on_excutive`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_report_on_excutive` AS SELECT
 1 AS `unique_id`,
  1 AS `executive_name`,
  1 AS `department`,
  1 AS `po_num`,
...
--
-- Temporary table structure for view `view_report_on_month`
--

DROP TABLE IF EXISTS `view_report_on_month`;
/*!50001 DROP VIEW IF EXISTS `view_report_on_month`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_report_on_month` AS SELECT
 1 AS `unique_id`,
  1 AS `po_num`,
  1 AS `executive_name`,
  1 AS `department`,
...
--
-- Temporary table structure for view `view_report_on_po_date`
--

DROP TABLE IF EXISTS `view_report_on_po_date`;
/*!50001 DROP VIEW IF EXISTS `view_report_on_po_date`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_report_on_po_date` AS SELECT
 1 AS `unique_id`,
  1 AS `po_num`,
  1 AS `po_date`,
  1 AS `executive_name`,
...
--
-- Temporary table structure for view `view_report_on_year`
--

DROP TABLE IF EXISTS `view_report_on_year`;
/*!50001 DROP VIEW IF EXISTS `view_report_on_year`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_report_on_year` AS SELECT
 1 AS `unique_id`,
  1 AS `po_num`,
  1 AS `po_date`,
  1 AS `department`,
...
--
-- Temporary table structure for view `view_sd_claim_pending`
--

DROP TABLE IF EXISTS `view_sd_claim_pending`;
/*!50001 DROP VIEW IF EXISTS `view_sd_claim_pending`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_sd_claim_pending` AS SELECT
 1 AS `bill_form_unique_id`,
  1 AS `acc_year`,
  1 AS `invoice_count`,
  1 AS `invoice_value` */;
...
--
-- Temporary table structure for view `view_sign_doc_list`
--

DROP TABLE IF EXISTS `view_sign_doc_list`;
/*!50001 DROP VIEW IF EXISTS `view_sign_doc_list`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_sign_doc_list` AS SELECT
 1 AS `ins_unique_id`,
  1 AS `bill_status`,
  1 AS `ir_status`,
  1 AS `invoice_no` */;
...
--
-- Temporary table structure for view `view_sign_document_vertification`
--

DROP TABLE IF EXISTS `view_sign_document_vertification`;
/*!50001 DROP VIEW IF EXISTS `view_sign_document_vertification`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_sign_document_vertification` AS SELECT
 1 AS `po_num`,
  1 AS `po_date`,
  1 AS `con_contact_name`,
  1 AS `con_address`,
...
--
-- Temporary table structure for view `view_sign_document_vertification_with_ins`
--

DROP TABLE IF EXISTS `view_sign_document_vertification_with_ins`;
/*!50001 DROP VIEW IF EXISTS `view_sign_document_vertification_with_ins`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_sign_document_vertification_with_ins` AS SELECT
 1 AS `po_num`,
  1 AS `po_date`,
  1 AS `con_contact_name`,
  1 AS `con_address`,
...
--
-- Temporary table structure for view `view_sign_document_vertification_with_ir`
--

DROP TABLE IF EXISTS `view_sign_document_vertification_with_ir`;
/*!50001 DROP VIEW IF EXISTS `view_sign_document_vertification_with_ir`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_sign_document_vertification_with_ir` AS SELECT
 1 AS `po_num`,
  1 AS `po_date`,
  1 AS `con_contact_name`,
  1 AS `con_address`,
...
--
-- Temporary table structure for view `view_sign_document_vertification_with_snr`
--

DROP TABLE IF EXISTS `view_sign_document_vertification_with_snr`;
/*!50001 DROP VIEW IF EXISTS `view_sign_document_vertification_with_snr`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_sign_document_vertification_with_snr` AS SELECT
 1 AS `po_num`,
  1 AS `po_date`,
  1 AS `con_contact_name`,
  1 AS `con_address`,
...
--
-- Temporary table structure for view `view_sign_document_vertification_without_ins`
--

DROP TABLE IF EXISTS `view_sign_document_vertification_without_ins`;
/*!50001 DROP VIEW IF EXISTS `view_sign_document_vertification_without_ins`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_sign_document_vertification_without_ins` AS SELECT
 1 AS `po_num`,
  1 AS `po_date`,
  1 AS `con_contact_name`,
  1 AS `con_address`,
...
--
-- Temporary table structure for view `view_sign_final_bg`
--

DROP TABLE IF EXISTS `view_sign_final_bg`;
/*!50001 DROP VIEW IF EXISTS `view_sign_final_bg`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_sign_final_bg` AS SELECT
 1 AS `po_num`,
  1 AS `po_unique_id`,
  1 AS `form_main_unique_id`,
  1 AS `po_date`,
...
--
-- Temporary table structure for view `view_sign_with_bg`
--

DROP TABLE IF EXISTS `view_sign_with_bg`;
/*!50001 DROP VIEW IF EXISTS `view_sign_with_bg`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_sign_with_bg` AS SELECT
 1 AS `po_num`,
  1 AS `po_unique_id`,
  1 AS `form_main_unique_id`,
  1 AS `po_date`,
...
--
-- Temporary table structure for view `view_sign_without_bg`
--

DROP TABLE IF EXISTS `view_sign_without_bg`;
/*!50001 DROP VIEW IF EXISTS `view_sign_without_bg`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_sign_without_bg` AS SELECT
 1 AS `form_main_unique_id`,
  1 AS `invoice_no`,
  1 AS `invoice_date`,
  1 AS `acc_year`,
...
--
-- Temporary table structure for view `view_snr_pending_count`
--

DROP TABLE IF EXISTS `view_snr_pending_count`;
/*!50001 DROP VIEW IF EXISTS `view_snr_pending_count`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_snr_pending_count` AS SELECT
 1 AS `po_num`,
  1 AS `acc_year`,
  1 AS `invoice_no`,
  1 AS `po_form_unique_id`,
...
--
-- Temporary table structure for view `view_status_invoice_list`
--

DROP TABLE IF EXISTS `view_status_invoice_list`;
/*!50001 DROP VIEW IF EXISTS `view_status_invoice_list`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_status_invoice_list` AS SELECT
 1 AS `unique_id`,
  1 AS `form_main_unique_id`,
  1 AS `po_unique_id`,
  1 AS `po_num`,
...
--
-- Temporary table structure for view `view_stock_completed_list`
--

DROP TABLE IF EXISTS `view_stock_completed_list`;
/*!50001 DROP VIEW IF EXISTS `view_stock_completed_list`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_stock_completed_list` AS SELECT
 1 AS `unique_id`,
  1 AS `form_main_unique_id`,
  1 AS `po_unique_id`,
  1 AS `po_num`,
...
--
-- Temporary table structure for view `view_stock_count_value`
--

DROP TABLE IF EXISTS `view_stock_count_value`;
/*!50001 DROP VIEW IF EXISTS `view_stock_count_value`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_stock_count_value` AS SELECT
 1 AS `acc_year`,
  1 AS `form_main_unique_id`,
  1 AS `remaining_qty`,
  1 AS `stock_qty`,
...
--
-- Temporary table structure for view `view_stock_position_com_list`
--

DROP TABLE IF EXISTS `view_stock_position_com_list`;
/*!50001 DROP VIEW IF EXISTS `view_stock_position_com_list`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_stock_position_com_list` AS SELECT
 1 AS `unique_id`,
  1 AS `po_unique_id`,
  1 AS `po_num`,
  1 AS `po_date`,
...
--
-- Temporary table structure for view `view_stock_position_list`
--

DROP TABLE IF EXISTS `view_stock_position_list`;
/*!50001 DROP VIEW IF EXISTS `view_stock_position_list`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_stock_position_list` AS SELECT
 1 AS `unique_id`,
  1 AS `po_unique_id`,
  1 AS `po_num`,
  1 AS `po_date`,
  ...
  1 AS `qty`,
  1 AS `net_value`,
  1 AS `product_due_days` */;
SET character_set_client = @saved_cs_client;

--
-- Temporary table structure for view `view_stock_position_list_1`
--

DROP TABLE IF EXISTS `view_stock_position_list_1`;
/*!50001 DROP VIEW IF EXISTS `view_stock_position_list_1`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_stock_position_list_1` AS SELECT
 1 AS `unique_id`,
  1 AS `po_unique_id`,
  1 AS `po_num`,
  1 AS `po_date`,
...
--
-- Temporary table structure for view `view_stock_position_pro_sub`
--

DROP TABLE IF EXISTS `view_stock_position_pro_sub`;
/*!50001 DROP VIEW IF EXISTS `view_stock_position_pro_sub`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_stock_position_pro_sub` AS SELECT
 1 AS `unique_id`,
  1 AS `po_unique_id`,
  1 AS `po_num`,
  1 AS `po_date`,
...
--
-- Temporary table structure for view `view_stock_position_pro_sub1`
--

DROP TABLE IF EXISTS `view_stock_position_pro_sub1`;
/*!50001 DROP VIEW IF EXISTS `view_stock_position_pro_sub1`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_stock_position_pro_sub1` AS SELECT
 1 AS `unique_id`,
  1 AS `po_num`,
  1 AS `stock_id`,
  1 AS `stock_date` */;
...
--
-- Temporary table structure for view `view_stock_position_processing`
--

DROP TABLE IF EXISTS `view_stock_position_processing`;
/*!50001 DROP VIEW IF EXISTS `view_stock_position_processing`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_stock_position_processing` AS SELECT
 1 AS `unique_id`,
  1 AS `po_unique_id`,
  1 AS `po_num`,
  1 AS `po_date`,
...
--
-- Temporary table structure for view `view_stock_qty`
--

DROP TABLE IF EXISTS `view_stock_qty`;
/*!50001 DROP VIEW IF EXISTS `view_stock_qty`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_stock_qty` AS SELECT
 1 AS `acc_year`,
  1 AS `form_main_unique_id`,
  1 AS `stock_qty`,
  1 AS `billed_qty`,
...
--
-- Temporary table structure for view `view_total_ld_invoice_count`
--

DROP TABLE IF EXISTS `view_total_ld_invoice_count`;
/*!50001 DROP VIEW IF EXISTS `view_total_ld_invoice_count`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_total_ld_invoice_count` AS SELECT
 1 AS `po_count`,
  1 AS `acc_year`,
  1 AS `total_invoice_count` */;
SET character_set_client = @saved_cs_client;

--
-- Temporary table structure for view `view_vendor_approval_list`
--

DROP TABLE IF EXISTS `view_vendor_approval_list`;
/*!50001 DROP VIEW IF EXISTS `view_vendor_approval_list`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_vendor_approval_list` AS SELECT
 1 AS `unique_id`,
  1 AS `venunique_id`,
  1 AS `invoice_no`,
  1 AS `invoice_date`,
  ...
  1 AS `document_verification_status`,
  1 AS `dc_required`,
  1 AS `vendor_inv_attach_approval_date`,
  1 AS `inv_verfiy_attach`,
  1 AS `po_ven_filename`,
  1 AS `vendor_bill_approval`,
  1 AS `vendor_bill_approval_date`,
  1 AS `veninvverifyid`,
  1 AS `bill_no`,
  1 AS `bill_date`,
  1 AS `accstatus`,
  1 AS `finance_reject_reason` */;
SET character_set_client = @saved_cs_client;

--
-- Temporary table structure for view `view_vendor_billdata`
--

DROP TABLE IF EXISTS `view_vendor_billdata`;
/*!50001 DROP VIEW IF EXISTS `view_vendor_billdata`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_vendor_billdata` AS SELECT
 1 AS `unique_id`,
  1 AS `form_main_unique_id`,
  1 AS `po_num`,
  1 AS `po_date`,
  ...
  1 AS `vendor_bulk_gst`,
  1 AS `bulk_total_amount`,
  1 AS `vendor_payment_status`,
  1 AS `document_verification_status` */;
SET character_set_client = @saved_cs_client;

--
-- Temporary table structure for view `view_vendor_pending_list`
--

DROP TABLE IF EXISTS `view_vendor_pending_list`;
/*!50001 DROP VIEW IF EXISTS `view_vendor_pending_list`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_vendor_pending_list` AS SELECT
 1 AS `form_main_unique_id`,
  1 AS `invoice_auto_id`,
  1 AS `po_num`,
  1 AS `po_date`,
...
--
-- Temporary table structure for view `view_verified_data`
--

DROP TABLE IF EXISTS `view_verified_data`;
/*!50001 DROP VIEW IF EXISTS `view_verified_data`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `view_verified_data` AS SELECT
 1 AS `po_num`,
  1 AS `po_date`,
  1 AS `ledger_name`,
  1 AS `team_member`,
...
--
-- Table structure for table `zone_creation`
--

DROP TABLE IF EXISTS `zone_creation`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `zone_creation` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `unique_id` varchar(50) NOT NULL,
  `is_active` int(11) NOT NULL DEFAULT 1,
  `is_delete` int(11) NOT NULL DEFAULT 0,
...
--
-- Dumping events for database 'otm_otm'
--

--
-- Dumping routines for database 'otm_otm'
--
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP FUNCTION IF EXISTS `check_file_name_null` */;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP FUNCTION IF EXISTS `cns_get_contact_name` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP FUNCTION IF EXISTS `cns_get_contact_number` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP FUNCTION IF EXISTS `get_address_po` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP FUNCTION IF EXISTS `get_consignee_contact_name` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP FUNCTION IF EXISTS `get_consignee_contact_no` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP FUNCTION IF EXISTS `get_consignee_district` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP FUNCTION IF EXISTS `get_consignee_state` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP FUNCTION IF EXISTS `get_cons_billed_qty` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP FUNCTION IF EXISTS `get_cons_verify_sts_by_consignee` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP FUNCTION IF EXISTS `get_contact_email_po` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP FUNCTION IF EXISTS `get_contact_no_po` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP FUNCTION IF EXISTS `get_department_by_form_id` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP FUNCTION IF EXISTS `get_department_name` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP FUNCTION IF EXISTS `get_district_name` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP FUNCTION IF EXISTS `get_district_name_po` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP FUNCTION IF EXISTS `get_executive_name` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP FUNCTION IF EXISTS `get_invoice_qty` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP FUNCTION IF EXISTS `get_invoice_value` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP FUNCTION IF EXISTS `get_item_name` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP FUNCTION IF EXISTS `get_ledger_name` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP FUNCTION IF EXISTS `get_ledger_no` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP FUNCTION IF EXISTS `get_name_stock` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP FUNCTION IF EXISTS `get_outsource_engineer_name` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP FUNCTION IF EXISTS `get_part_no` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP FUNCTION IF EXISTS `get_pincode` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP FUNCTION IF EXISTS `get_po_date` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP FUNCTION IF EXISTS `get_po_date_stock` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP FUNCTION IF EXISTS `get_po_number` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP FUNCTION IF EXISTS `get_po_num_by_po_unique_id` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP FUNCTION IF EXISTS `get_remaining_stock_qty` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP FUNCTION IF EXISTS `get_sector_name` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP FUNCTION IF EXISTS `get_service_engineer_name` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP FUNCTION IF EXISTS `get_staff_name` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP FUNCTION IF EXISTS `get_staff_name_by_id` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP FUNCTION IF EXISTS `get_staff_name_unique_id` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP FUNCTION IF EXISTS `get_staff_name_with_staff_id` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP FUNCTION IF EXISTS `get_state_name` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP FUNCTION IF EXISTS `get_state_name_po` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP FUNCTION IF EXISTS `get_total_stock_qty` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP FUNCTION IF EXISTS `get_unique_id_by_tender` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP FUNCTION IF EXISTS `get_user_name_by_id` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP FUNCTION IF EXISTS `get_vendor_address` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP FUNCTION IF EXISTS `get_vendor_company_name` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP FUNCTION IF EXISTS `get_vendor_contact` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP FUNCTION IF EXISTS `get_vendor_id` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP FUNCTION IF EXISTS `get_vendor_mail` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `bill_generation_pending` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `bill_generation_pending`()
BEGIN
    
    TRUNCATE TABLE bill_generation_summary;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `ClearDeletedsignInvoiceVerification` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `ClearDeletedsignInvoiceVerification`()
BEGIN
    UPDATE
        invoice_verfication_table ivt
    JOIN sign_doc_verification_detail icm ON
        ivt.invoice_no = icm.invoice_no
    SET
        ivt.inv_verify_status = NULL, ivt.inv_verify_approvedby = NULL, ivt.inv_verify_approved_date = NULL
    WHERE
        icm.is_delete = 1;
END ;;
DELIMITER ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `customer_detail`(IN `po_unique_id` VARCHAR(100))
BEGIN
    SELECT 
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `dc_num_insertion_from_invoice` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `dc_num_insertion_from_invoice`()
BEGIN
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `GetConsigneeDetailsById` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `GetConsigneeDetailsById`(IN `input_unique_id` VARCHAR(255) CHARSET utf8mb4)
BEGIN
    SELECT 
        con_contact_name,
        con_contact_number,
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `GetCustomerDetailByponum` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `GetCustomerDetailByponum`(IN `p_unique_id` VARCHAR(50))
BEGIN
    SELECT 
        department, 
        bill_address, 
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `get_po_details_by_number` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `get_po_details_by_number`(IN `in_po_num` VARCHAR(100))
BEGIN
    SELECT
        DATE_FORMAT(po_date, '%d-%m-%Y') AS po_date,
        get_department_name(department) AS department,
        bill_address,
        gst_value,
        total_qty AS qty,
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `insert_into_dc_num_status` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `insert_into_dc_num_status`()
BEGIN
    INSERT INTO dc_num_status (
        unique_id,
        form_main_unique_id,
        po_unique_id,
        po_num,
    ...
    SELECT 
        CONCAT('68', LEFT(REPLACE(UUID(), '-', ''), 16)),
    ...
    WHERE icm.is_delete = 0 
      ...
      AND NOT EXISTS (
          SELECT 1
          FROM dc_num_status ivt
          WHERE ivt.invoice_auto_id = icm.invoice_auto_id
      );
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `insert_into_invoice_verification` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `insert_into_invoice_verification`(IN `p_dc_number` VARCHAR(100), IN `p_invoice_no` VARCHAR(100), IN `p_po_unique_id` VARCHAR(100))
BEGIN
    ...
    SELECT 
        ...
        icm.material_qc_reject_reason,
        icm.acc_year
    FROM invoice_creation_main icm
    WHERE icm.dc_number = p_dc_number
      AND icm.invoice_no = p_invoice_no
      AND icm.form_main_unique_id = p_po_unique_id
      AND icm.is_delete = 0
      AND NOT EXISTS (
          SELECT 1
          FROM invoice_verfication_table ivt
          WHERE ivt.dc_number = icm.dc_number
            AND ivt.invoice_no = icm.invoice_no
      );
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `insert_po_combined_summary` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `insert_po_combined_summary`()
BEGIN
    
    TRUNCATE TABLE operation_team_beta.po_combined_summary;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `insert_po_product_assign_details` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `insert_po_product_assign_details`(IN `p_unique_id` VARCHAR(50), IN `p_form_main_unique_id` VARCHAR(50), IN `p_con_unique_id` VARCHAR(50), IN `p_con_name` LONGTEXT, IN `p_con_contact_no` LONGTEXT, IN `p_con_address` LONGTEXT, IN `p_unit_price` LONGTEXT, IN `p_product_unique_id` LONGTEXT, IN `p_item_code` LONGTEXT, IN `p_product` LONGTEXT, IN `p_qty` INT(250), IN `p_assign_qty` INT(250), IN `p_batch_id` VARCHAR(50), IN `p_po_num` VARCHAR(250))
BEGIN
    INSERT INTO po_product_assign_details (
        unique_id,
        form_main_unique_id,
        con_unique_id,
        con_name,
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `insert_stock_summary_by_year` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `insert_stock_summary_by_year`()
BEGIN
    INSERT INTO stock_invoice_summary (acc_year, po_count, stock_value)
    SELECT
        stock.acc_year AS acc_year,
        COUNT(DISTINCT(stock.form_main_unique_id)) AS po_count,
        ROUND(
            SUM(CAST(stock.stock_value AS DECIMAL(10, 2))),
            2
        ) AS stock_value
    FROM
        operation_team_beta.stock_position_main stock
    WHERE
        stock.is_delete = '0'
        AND stock.billed_qty IS NULL
    GROUP BY
        stock.acc_year;
END ;;
DELIMITER ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `invoice_par_rem_qty_update` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `invoice_par_rem_qty_update`(IN `p_form_main_unique_id` VARCHAR(255), IN `p_dc_num` VARCHAR(255))
BEGIN
    DECLARE v_par_qty BIGINT DEFAULT 0;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `po_total_values_update` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `po_total_values_update`(IN `p_form_main_unique_id` VARCHAR(255), IN `p_qty` DECIMAL(10,2), IN `p_total_value` DECIMAL(15,2))
BEGIN
    DECLARE v_total_qty DECIMAL(10,2) DEFAULT 0;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `po_total_values_updates` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `po_total_values_updates`(IN `p_form_main_unique_id` VARCHAR(255))
BEGIN
  DECLARE v_qty_total DECIMAL(10,2) DEFAULT 0.00;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `process_po_form_data` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `process_po_form_data`(IN `in_form_main_unique_id` VARCHAR(50))
BEGIN
    DECLARE v_po_id VARCHAR(50);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `railways_item_creation_price_update` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `railways_item_creation_price_update`(IN `item_unique_id` VARCHAR(255), IN `v_compare_unique_id` VARCHAR(255), IN `v_net_price` DECIMAL(15,2))
BEGIN
    
    UPDATE railways_item_creation
    SET 
        common_uni_id = v_compare_unique_id,
        adv_value     = v_net_price
    WHERE 
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `run_full_po_processing_3` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `run_full_po_processing_3`()
BEGIN
    DECLARE done INT DEFAULT FALSE;
END ;;
DELIMITER ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_generate_delivery_status_in_transit` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_generate_delivery_status_in_transit`()
BEGIN
    INSERT INTO delivery_status_in_transit (acc_year, po_count, invoice_count, invoice_value)
    SELECT
        `dispatch`.`acc_year` AS `acc_year`,
        COUNT(DISTINCT `dispatch`.`po_form_unique_id`) AS `po_count`,
        COUNT(`invoice_main`.`invoice_no`) AS `invoice_count`,
        ROUND(
            SUM(CAST(`invoice_main`.`invoice_value` AS DECIMAL(10, 2))),
            2
        ) AS `invoice_value`
    FROM
        `operation_team_beta`.`dispatch_list` `dispatch`
    LEFT JOIN `operation_team_beta`.`invoice_creation_main` `invoice_main`
        ON `dispatch`.`po_form_unique_id` = `invoice_main`.`form_main_unique_id`
        AND `dispatch`.`invoice_no` = `invoice_main`.`invoice_no`
        AND `dispatch`.`consignee_unique_id` = `invoice_main`.`consignee_unique_id`
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_generate_invoice_summary` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_generate_invoice_summary`()
BEGIN
    INSERT INTO invoice_summary (acc_year, po_count, invoice_count, invoice_value)
    SELECT
        `invoice`.`acc_year`,
        COUNT(`invoice`.`form_main_unique_id`) AS `po_count`,
        COUNT(DISTINCT `invoice`.`unique_id`) AS `invoice_count`,
        ROUND(
            SUM(CAST(`invoice`.`invoice_value` AS DECIMAL(10, 2))),
            2
        ) AS `invoice_value`
    FROM
        `operation_team_beta`.`invoice_creation_main` `invoice`
    WHERE
        `invoice`.`is_delete` = 0 AND (
            `invoice`.`invoice_doc_status` = '0' OR
            `invoice`.`invoice_doc_status` = '2'
        )
    GROUP BY
        `invoice`.`acc_year`;
END ;;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_generate_invoice_summary_approved` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_generate_invoice_summary_approved`()
BEGIN
    INSERT INTO invoice_summary_approved (acc_year, po_count, invoice_count, invoice_value)
    SELECT
        `invoice`.`acc_year`,
        COUNT(DISTINCT `invoice`.`form_main_unique_id`) AS `po_count`,
        COUNT(DISTINCT `invoice`.`unique_id`) AS `invoice_count`,
        ROUND(
            SUM(CAST(`invoice`.`invoice_value` AS DECIMAL(10, 2))),
            2
    ...
    WHERE
        `invoice`.`is_delete` = '0'
        AND `invoice`.`invoice_doc_status` = '4'
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_generate_invoice_summary_pending_dispatch` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_generate_invoice_summary_pending_dispatch`()
BEGIN
    INSERT INTO invoice_summary_pending_dispatch (acc_year, po_count, invoice_count, invoice_value)
    SELECT
        `invoice_main`.`acc_year`,
        COUNT(DISTINCT `invoice_main`.`form_main_unique_id`) AS `po_count`,
        COUNT(DISTINCT `invoice_main`.`invoice_no`) AS `invoice_count`,
        ROUND(
            SUM(CAST(`invoice_main`.`invoice_value` AS DECIMAL(10, 2))),
            2
        ) AS `invoice_value`
    FROM
        `operation_team_beta`.`invoice_creation_main` `invoice_main`
    WHERE
        `invoice_main`.`dispatch_status` = '0'
        AND `invoice_main`.`ac_team_verifiy_status` = 1
        AND `invoice_main`.`is_delete` = '0'
    GROUP BY
        `invoice_main`.`acc_year`;
END ;;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_update_invoice_summary` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_update_invoice_summary`()
BEGIN
    
    DELETE FROM `operation_team_beta`.`opera_doc_table`;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `UpdateAllTeamMembers` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `UpdateAllTeamMembers`()
BEGIN
    UPDATE invoice_creation_main AS inv
    JOIN consignee_details_sub AS cons
      ON inv.consignee_unique_id = cons.unique_id
    SET inv.team_mem = cons.assign_team_member
    WHERE inv.is_delete = 0
      AND cons.is_delete = 0
      AND inv.team_mem IS NOT NULL
      AND inv.team_mem != '';
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `UpdateAllTeamMembers1` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `UpdateAllTeamMembers1`()
BEGIN
        
    UPDATE
        invoice_creation_main AS inv
    JOIN consignee_details_sub AS cons
    ON
        inv.consignee_unique_id = cons.unique_id
    SET
        inv.team_mem = cons.assign_team_member
    WHERE
        inv.is_delete = 0 AND cons.is_delete = 0 AND inv.team_mem IS NOT NULL AND inv.team_mem != '';
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `UpdateDocumentVerificationStatusdelete` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `UpdateDocumentVerificationStatusdelete`()
BEGIN
   
    
    UPDATE invoice_verfication_table ivt
    JOIN (
        SELECT dc_number
        FROM installation_details_sublist
        WHERE is_delete = '1'
    ) AS deleted_ids ON ivt.dc_number = deleted_ids.dc_number
    SET ivt.document_verification_status = NULL;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `UpdateInvoiceVerificationsts` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `UpdateInvoiceVerificationsts`()
BEGIN
    UPDATE
        invoice_verfication_table ivt
    JOIN sign_doc_verification_detail icm ON
        ivt.invoice_no = icm.invoice_no
    SET
        ivt.inv_verify_status = icm.inv_verify_status, ivt.inv_verify_approvedby = icm.inv_verify_approvedby, ivt.inv_verify_approved_date = icm.inv_verify_approved_date
    WHERE
        icm.is_delete = 0;
END ;;
DELIMITER ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `UpdatePO_consignee_sts_basedOnConsigneetable` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `UpdatePO_consignee_sts_basedOnConsigneetable`(IN `input_po_uid` VARCHAR(100))
BEGIN
    UPDATE po_form po
    JOIN (
        SELECT 
            po.unique_id,
            COUNT(cds.id) AS consignee_cnt
        FROM 
            po_form po
        JOIN 
            consignee_details_sub cds 
                ON cds.form_main_unique_id = po.unique_id AND cds.is_delete = 0
        WHERE 
            po.is_delete = 0
            AND po.unique_id = input_po_uid
        GROUP BY 
            po.unique_id
    ) AS derived 
    ON derived.unique_id = po.unique_id
    SET po.product_sts = 1
    WHERE 
        po.is_delete = 0
        AND po.unique_id = input_po_uid
        AND po.no_of_consignee = derived.consignee_cnt;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `UpdatePO_product_sts_basedonProductCount` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `UpdatePO_product_sts_basedonProductCount`(IN `input_po_uid` VARCHAR(100))
BEGIN
    UPDATE po_form po
    JOIN (
        SELECT 
            po.unique_id,
            COUNT(ps.id) AS product_cnt
        FROM 
            po_form po
        JOIN 
            product_details_sub ps 
                ON ps.form_main_unique_id = po.unique_id AND ps.is_delete = 0
        WHERE 
            po.is_delete = 0
            AND po.unique_id = input_po_uid
        GROUP BY 
    ...
    WHERE 
        po.is_delete = 0
        AND po.unique_id = input_po_uid
        AND po.no_of_po = derived.product_cnt;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `UpdateSignPOInvoiceSummary` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `UpdateSignPOInvoiceSummary`()
BEGIN
   INSERT INTO `operation_team_beta`.`installation_summary` (
    `acc_year`,
    `sign_po_count`,
    `sign_invoice_count`,
    `sign_invoice_value`
...
SELECT
    `sign`.`acc_year` AS `acc_year`,
    COUNT(DISTINCT `sign`.`form_main_unique_id`) AS `sign_po_count`,
    COUNT(`sign`.`invoice_no`) AS `sign_invoice_count`,
    SUM(`sign`.`invoice_value`) AS `sign_invoice_value`
FROM
    `operation_team_beta`.`view_sign_document_vertification` AS `sign`
LEFT JOIN `operation_team_beta`.`sign_doc_verification_detail` AS `doc`
    ON `doc`.`form_main_unique_id` = `sign`.`form_main_unique_id`
    AND `sign`.`consignee_unique_id` = `doc`.`con_unique_id`
    AND `sign`.`invoice_no` = `doc`.`invoice_no`
    AND `doc`.`is_delete` = '0'
WHERE
    `sign`.`document_verification_status` = '0'
    AND `doc`.`invoice_no` IS NULL
    AND (`sign`.`dc_delivery_status` = '3' OR `sign`.`dc_delivery_status` = '1')
GROUP BY
    `sign`.`acc_year`
ON DUPLICATE KEY UPDATE
    `sign_po_count` = VALUES(`sign_po_count`),
    `sign_invoice_count` = VALUES(`sign_invoice_count`),
    `sign_invoice_value` = VALUES(`sign_invoice_value`);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `update_amc_total_value` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `update_amc_total_value`()
BEGIN
    
    UPDATE po_department_count
    SET amc_total_value = 0;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `update_bill_submission_pending_summary` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `update_bill_submission_pending_summary`()
BEGIN
 TRUNCATE TABLE bill_submission_pending_summary;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `update_dc_num_dispatch_sts` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `update_dc_num_dispatch_sts`()
BEGIN
    UPDATE dc_num_status AS ivt
    JOIN dispatch_list AS icm 
        ON ivt.dc_number = icm.dc_number
    SET ivt.delivery_status = icm.status,
    	ivt.dc_dispatch_date = icm.delivery_date
    WHERE icm.is_delete = 0;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `update_doc_verifi_ac` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `update_doc_verifi_ac`()
BEGIN
    
    REPLACE INTO `operation_team_beta`.`document_Verification_Accounts` (
        `acc_year`, `po_count`, `invoice_count`, `invoice_value`
    )
    SELECT
        `invoice_main`.`acc_year`,
        COUNT(DISTINCT `invoice_main`.`form_main_unique_id`) AS `po_count`,
        COUNT(DISTINCT `invoice_main`.`unique_id`) AS `invoice_count`,
        ROUND(SUM(CAST(`invoice_main`.`invoice_value` AS DECIMAL(10, 2))), 2) AS `invoice_value`
    FROM
        `operation_team_beta`.`invoice_creation_main` AS `invoice_main`
    WHERE
        `invoice_main`.`doc_approval_sts` = '1'
        AND `invoice_main`.`ac_team_verifiy_status` = '0'
        AND `invoice_main`.`is_delete` = '0'
    GROUP BY
        `invoice_main`.`acc_year`;
END ;;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `update_installation_summary` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `update_installation_summary`()
BEGIN
    ...
    SELECT
        ...
        ROUND(SUM(CAST(`invoice_value` AS DECIMAL(10,2))), 2) AS `invoice_value`
    FROM `operation_team_beta`.`view_installation_followups`
    WHERE `installation_status` IN ('0', '3', '4')
    GROUP BY `acc_year`
    ON DUPLICATE KEY UPDATE
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `update_invoice_bill_status` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `update_invoice_bill_status`()
BEGIN
    
    UPDATE invoice_verfication_table ivt
    SET 
        ivt.bill_status = (
            SELECT icm.bill_status
            FROM sign_doc_verification_detail icm
            WHERE icm.dc_number = ivt.dc_number
            LIMIT 1
        ),
        ivt.status_app = (
            SELECT icm.status_app
            FROM sign_doc_verification_detail icm
            WHERE icm.dc_number = ivt.dc_number
            LIMIT 1
        ),
        ivt.without_bg = (
            SELECT icm.without_bg
            FROM sign_doc_verification_detail icm
            WHERE icm.dc_number = ivt.dc_number
            LIMIT 1
        ),
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `update_invoice_bill_status_1` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `update_invoice_bill_status_1`()
BEGIN
    UPDATE sign_doc_verification_detail ivt
    JOIN bill_submission_form icm 
        ON icm.dc_number = ivt.dc_number
    SET 
        ivt.bill_status = icm.bill_status
    WHERE ivt.is_delete = '0';
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `update_invoice_verification_1_snr` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `update_invoice_verification_1_snr`()
BEGIN
    ...
    JOIN (
        ...
        HAVING 
            SUM(CASE WHEN documents_type1 = 'IR' THEN 1 ELSE 0 END) > 0 AND
            SUM(CASE WHEN documents_type2 = 'SNR' THEN 1 ELSE 0 END) > 0
    ) AS valid_docs
    ON ivt.invoice_no = valid_docs.invoice_no AND ivt.dc_number = valid_docs.dc_number
    SET ivt.document_verification_status = 2;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `update_invoice_verification_by_dcnumber` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `update_invoice_verification_by_dcnumber`(IN `p_dc_number` VARCHAR(50))
BEGIN
    UPDATE invoice_verfication_table AS ivt
    INNER JOIN invoice_creation_main AS icm
        ON ivt.dc_number = icm.dc_number
    SET
        ivt.unique_id = icm.unique_id,
        ivt.form_main_unique_id = icm.form_main_unique_id,
        ivt.po_num = icm.po_num,
        ivt.po_date = icm.po_date,
        ivt.dc_date = icm.dc_date,
        ivt.invoice_no = icm.invoice_no,
        ivt.invoice_date = icm.invoice_date,
        ivt.ledger_name = icm.ledger_name,
        ivt.ledger_no = icm.ledger_no,
        ivt.consignee_unique_id = icm.consignee_unique_id,
        ivt.engineer_name = icm.engineer_name,
        ivt.invoice_qty = icm.invoice_qty,
        ivt.invoice_value = icm.invoice_value,
        ivt.invoice_doc_status = icm.invoice_doc_status,
        ivt.doc_approval_sts = icm.doc_approval_sts,
        ivt.approved_by = icm.approved_by,
        ivt.approved_date = icm.approved_date,
        ivt.ac_team_verifiy_status = icm.ac_team_verifiy_status,
        ivt.ac_team_approved_by = icm.ac_team_approved_by,
        ivt.dispatch_status = icm.dispatch_status,
        ivt.installation_status = icm.installation_status,
        ivt.material_qc = icm.material_qc,
        ivt.material_qc_approved = icm.material_qc_approved,
        ivt.material_qc_reject_reason = icm.material_qc_reject_reason,
        ivt.vendor_bulk_sts = icm.vendor_bulk_sts,
        ivt.bulk_eng_type = icm.bulk_eng_type,
        ivt.bulk_eng_name = icm.bulk_eng_name,
        ivt.vendor_bulk_rate = icm.vendor_bulk_rate,
        ivt.vendor_bulk_gst = icm.vendor_bulk_gst,
        ivt.bulk_total_amount = icm.bulk_total_amount,
        ivt.vendor_bulk_timeline = icm.vendor_bulk_timeline,
        ivt.vendor_inst_allocation_date = icm.`date`
    WHERE icm.is_delete = 0
      AND icm.dc_number = p_dc_number;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `update_invoice_verify_installdcir_status` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `update_invoice_verify_installdcir_status`()
BEGIN
    UPDATE invoice_verfication_table ivt
    JOIN installation_details icm 
        ON ivt.dc_number = icm.dc_number
    SET
        ivt.dc_delivery_status = icm.dc_delivery_status,
 ivt.dc_required = icm.dc_required
    WHERE icm.is_delete = 0;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `update_invverfystatusappbillupdate` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `update_invverfystatusappbillupdate`()
BEGIN
    UPDATE
        invoice_verfication_table ivt
    JOIN sign_doc_verification_detail icm ON
        ivt.invoice_no = icm.invoice_no
    SET
        ivt.status_app = icm.status_app, ivt.bill_status = icm.bill_status
    WHERE
        icm.is_delete = 0;
END ;;
DELIMITER ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `update_inv_verfiy_document_verification_status` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `update_inv_verfiy_document_verification_status`()
UPDATE invoice_verfication_table ivt
JOIN (
    SELECT invoice_no, dc_number, document_verification_status
    FROM installation_details_sublist
    WHERE (documents_type2 <> 'SNR' OR documents_type2 IS NULL OR documents_type2 = '0')
  AND is_delete = '0'
) AS ids
ON ivt.dc_number = ids.dc_number
SET ivt.document_verification_status = ids.document_verification_status ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `update_inv_verfiy_update_dispatch_sts` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `update_inv_verfiy_update_dispatch_sts`()
BEGIN
    UPDATE invoice_verfication_table ivt
    JOIN dispatch_list icm 
        ON ivt.dc_number = icm.dc_number
    SET
        ivt.dispatch_com_status = icm.status
    WHERE icm.is_delete = 0;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `update_opera_sign_table` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `update_opera_sign_table`()
BEGIN
    INSERT INTO operation_team_beta.opera_sign_table (
        acc_year,
        sign_po_count,
        sign_invoice_count,
        sign_dc_count,
    ...
    SELECT
        sign.acc_year AS acc_year,
        COUNT(DISTINCT sign.form_main_unique_id) AS sign_po_count,
        COUNT(DISTINCT doc.dc_number) AS sign_dc_count,
        COUNT(DISTINCT sign.invoice_no) AS sign_invoice_count,
        SUM(sign.invoice_value) AS sign_invoice_value
    FROM
        operation_team_beta.view_sign_document_vertification AS sign
    LEFT JOIN 
        operation_team_beta.sign_doc_verification_detail AS doc
        ON doc.form_main_unique_id = sign.form_main_unique_id
        AND sign.invoice_no = doc.invoice_no
        AND doc.is_delete = '0'
    WHERE
    ...
    ON DUPLICATE KEY UPDATE
        sign_po_count = VALUES(sign_po_count),
        sign_invoice_count = VALUES(sign_invoice_count),
        sign_dc_count = VALUES(sign_dc_count),
        sign_invoice_value = VALUES(sign_invoice_value);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `update_po_department_count` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `update_po_department_count`()
BEGIN
    
    DELETE FROM po_department_count;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `update_po_form_stock_status` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `update_po_form_stock_status`()
BEGIN
    UPDATE po_form pf
    SET pf.status = 2
    WHERE pf.status != 2
      AND COALESCE((
            SELECT SUM(CAST(NULLIF(pds.qty, '') AS DECIMAL(18,2)))
            FROM product_details_sub pds
            WHERE pds.form_main_unique_id = pf.unique_id and pds.is_delete = 0
        ), 0) = COALESCE((
            SELECT SUM(CAST(NULLIF(spm.stock_qty, '') AS DECIMAL(18,2)))
            FROM stock_position_main spm
            WHERE spm.form_main_unique_id = pf.unique_id and spm.is_delete = 0
        ), 0);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `update_po_product_assign_details` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `update_po_product_assign_details`(IN `p_form_main_unique_id` VARCHAR(255), IN `p_batch_id` VARCHAR(255), IN `p_item_code` VARCHAR(255), IN `p_con_unique_id` VARCHAR(255), IN `p_con_name` VARCHAR(255), IN `p_con_contact_no` VARCHAR(255), IN `p_con_address` LONGTEXT, IN `p_unit_price` DECIMAL(10,2), IN `p_product_unique_id` VARCHAR(255), IN `p_product` LONGTEXT, IN `p_qty` INT, IN `p_assign_qty` INT, IN `p_po_num` VARCHAR(255))
BEGIN
    UPDATE po_product_assign_details
    SET 
        con_unique_id = p_con_unique_id,
        con_name = p_con_name,
        con_contact_no = p_con_contact_no,
        con_address = p_con_address,
        unit_price = p_unit_price,
        product_unique_id = p_product_unique_id,
        product = p_product,
        qty = p_qty,
        assign_qty = p_assign_qty,
        po_num = p_po_num 
    WHERE 
        form_main_unique_id = p_form_main_unique_id
        AND batch_id = p_batch_id
        AND product_unique_id = p_product_unique_id
        and  con_unique_id = p_con_unique_id;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `update_sign_doc_summary` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `update_sign_doc_summary`()
BEGIN
    
    TRUNCATE TABLE sign_doc_summary;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `update_snr_installation_summary` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `update_snr_installation_summary`()
BEGIN
    INSERT INTO `operation_team_beta`.`installation_summary` (
        `acc_year`,
        `snr_po_count`,
    ...
    SELECT
        `invoice`.`acc_year`,
        COUNT(DISTINCT `install`.`po_form_unique_id`),
        SUM(DISTINCT `invoice`.`invoice_value`),
        COUNT(DISTINCT `install`.`unique_id`)
    FROM
        `operation_team_beta`.`installation_details` AS `install`
    JOIN
        `operation_team_beta`.`invoice_creation_main` AS `invoice`
        ON `invoice`.`invoice_no` = `install`.`invoice_no`
        AND `invoice`.`is_delete` = '0'
    WHERE
        `install`.`is_delete` = '0'
        AND `invoice`.`installation_status` = '1'
    GROUP BY
        `invoice`.`acc_year`
    ON DUPLICATE KEY UPDATE
        `snr_po_count` = VALUES(`snr_po_count`),
        `snr_invoice_value` = VALUES(`snr_invoice_value`),
        `snr_install_count` = VALUES(`snr_install_count`);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `update_vendor_payment_count` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `update_vendor_payment_count`()
BEGIN
    
    DELETE FROM vendor_payment_count;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `vendor_details` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `vendor_details`(IN `p_unique_id` VARCHAR(100))
BEGIN
    SELECT * 
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `vendor_issue_count` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `vendor_issue_count`()
BEGIN
    UPDATE vendor_payment_count vpc
    JOIN (
        SELECT 
            vendor_id,
            SUM(amount) AS ttlamount,
            COUNT(dc_num) AS dc_count
        FROM vendor_payment_details
        GROUP BY vendor_id
    ) vpd ON vpc.vendor_id = vpd.vendor_id
    SET 
        vpc.issue_dc_count = vpd.dc_count,
        vpc.issue_dc_value = vpd.ttlamount;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
--
-- Final view structure for view `bill_submitted_payment_pending`
--
...
/*!50001 VIEW `bill_submitted_payment_pending` AS select cast('' as char(100) charset utf8mb4) AS `bill_form_unique_id`,cast('' as char(10) charset utf8mb4) AS `acc_year`,cast(0 as signed) AS `invoice_count`,cast(0 as decimal(15,2)) AS `invoice_value` from DUAL  where 1 = 0 */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `po_consignee_assign`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `view_delivery_confirmation` AS select `dispatch`.`unique_id` AS `unique_id`,`dispatch`.`po_num` AS `po_num`,`dispatch`.`po_date` AS `po_date`,`dispatch`.`po_form_unique_id` AS `po_form_unique_id`,`dispatch`.`invoice_auto_id` AS `invoice_auto_id`,`dispatch`.`invoice_no` AS `invoice_no`,`inv`.`invoice_value` AS `invoice_value`,`inv`.`ledger_name` AS `ledger_name`,`inv`.`team_mem` AS `team_mem`,`dispatch`.`invoice_date` AS `invoice_date`,`dispatch`.`dc_number` AS `dc_number`,`dispatch`.`dc_date` AS `dc_date`,`dispatch`.`pod_no` AS `pod_no`,`dispatch`.`delivery_status` AS `delivery_status`,`dispatch`.`delivery_date` AS `delivery_date`,`dispatch`.`delivery_proof` AS `delivery_proof`,`dispatch`.`name_of_courier` AS `name_of_courier`,`dispatch`.`delv_conf_person` AS `delv_conf_person`,`dispatch`.`delv_conf_date` AS `delv_conf_date`,`dispatch`.`mode_of_delivery` AS `mode_of_delivery`,`dispatch`.`status` AS `status`,`dispatch`.`consignee_unique_id` AS `consignee_unique_id`,`stock_position_main`.`department` AS `department` from ((`dispatch_list` `dispatch` left join `stock_position_main` on(`dispatch`.`po_form_unique_id` = `stock_position_main`.`form_main_unique_id` and `stock_position_main`.`is_delete` = '0')) left join `invoice_creation_main` `inv` on(`dispatch`.`po_form_unique_id` = `inv`.`form_main_unique_id` and `dispatch`.`invoice_no` = `inv`.`invoice_no` and `inv`.`is_delete` = '0')) where `dispatch`.`is_delete` = 0 and `dispatch`.`status` = '2' or `dispatch`.`status` = '3' group by `dispatch`.`dc_number` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `view_dispatch_complete_count`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `view_dispatch_delivery_list` AS select `dispatch`.`unique_id` AS `unique_id`,`dispatch`.`po_num` AS `po_num`,`dispatch`.`po_date` AS `po_date`,`dispatch`.`po_form_unique_id` AS `po_form_unique_id`,`dispatch`.`invoice_auto_id` AS `invoice_auto_id`,`dispatch`.`invoice_no` AS `invoice_no`,`inv`.`invoice_value` AS `invoice_value`,`inv`.`ledger_name` AS `ledger_name`,`inv`.`team_mem` AS `team_mem`,`dispatch`.`invoice_date` AS `invoice_date`,`dispatch`.`dc_number` AS `dc_number`,`dispatch`.`dc_date` AS `dc_date`,`dispatch`.`pod_no` AS `pod_no`,`dispatch`.`delivery_status` AS `delivery_status`,`dispatch`.`delivery_date` AS `delivery_date`,`dispatch`.`delivery_proof` AS `delivery_proof`,`dispatch`.`einvoice_file` AS `einvoice`,`dispatch`.`pod_proof` AS `pod_proof`,`dispatch`.`name_of_courier` AS `name_of_courier`,`dispatch`.`mode_of_delivery` AS `mode_of_delivery`,`dispatch`.`status` AS `status`,`dispatch`.`consignee_unique_id` AS `consignee_unique_id`,`stock_position_main`.`department` AS `department` from ((`dispatch_list` `dispatch` left join `stock_position_main` on(`dispatch`.`po_form_unique_id` = `stock_position_main`.`form_main_unique_id` and `stock_position_main`.`is_delete` = '0')) left join `invoice_creation_main` `inv` on(`dispatch`.`po_form_unique_id` = `inv`.`form_main_unique_id` and `dispatch`.`invoice_no` = `inv`.`invoice_no` and `inv`.`is_delete` = '0')) where `dispatch`.`is_delete` = 0 and (`dispatch`.`status` = '2' or `dispatch`.`status` = '3') group by `dispatch`.`dc_number` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `view_dispatch_delivery_list_2`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `view_ld_value_count` AS select cast('' as char(100) charset utf8mb4) AS `bill_form_unique_id`,cast('' as char(10) charset utf8mb4) AS `acc_year`,cast(0 as signed) AS `invoice_count`,cast(0 as decimal(15,2)) AS `ld_value` from DUAL  where 1 = 0 */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `view_sd_claim_pending` AS select cast('' as char(100) charset utf8mb4) AS `bill_form_unique_id`,cast('' as char(10) charset utf8mb4) AS `acc_year`,cast(0 as signed) AS `invoice_count`,cast(0 as decimal(15,2)) AS `invoice_value` from DUAL  where 1 = 0 */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `view_sign_doc_list`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `view_sign_doc_list` AS select `sign_doc`.`ins_unique_id` AS `ins_unique_id`,`sign_doc`.`bill_status` AS `bill_status`,`sign_doc`.`ir_status` AS `ir_status`,`sign_doc`.`invoice_no` AS `invoice_no` from `sign_doc_verification_detail` `sign_doc` where `sign_doc`.`is_delete` = '0' */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `view_sign_document_vertification`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `view_stock_position_pro_sub1` AS select `a`.`unique_id` AS `unique_id`,`a`.`po_num` AS `po_num`,`b`.`stock_id` AS `stock_id`,`b`.`stock_date` AS `stock_date` from (`po_form` `a` join `stock_position` `b` on(`a`.`unique_id` = `b`.`form_main_unique_id`)) where `a`.`is_delete` = 0 and `b`.`is_delete` = 0 group by `a`.`unique_id` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `view_stock_position_processing`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `view_total_ld_invoice_count` AS select `invoice`.`po_unique_id` AS `po_count`,`invoice`.`acc_year` AS `acc_year`,count(distinct `invoice`.`unique_id`) AS `total_invoice_count` from `invoice_creation` `invoice` where `invoice`.`invoice_no` <> '' and `invoice`.`is_delete` = '0' */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `view_vendor_approval_list`
--
...
-- Dump completed on 2026-05-08 17:12:24
