...
export default function AccountsBillEntryForm() {
  ...
  return (
    <div className="p-6">
      <PageTopbar
        title={isEdit ? "Edit Accounts Bill Entry" : "Add Accounts Bill Entry"}
        breadcrumbs={["Vendor Payment", "Accounts Team Bill Entry", isEdit ? "Edit" : "Add"]}
      />
        ...
        <form onSubmit={handleSubmit}>
          <HorizontalFormBody className="space-y-6">
            <p className="max-w-2xl text-[13px] leading-6 text-ink-secondary">
              Keep the accounts bill entry setup in the same cleaner vendor form layout used across the refreshed module.
            </p>
