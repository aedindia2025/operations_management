...
export default function AccountsBillApprovalForm() {
  ...
  return (
    <div className="p-6">
      <PageTopbar
        title={isEdit ? "Edit Accounts Bill Approval" : "Add Accounts Bill Approval"}
        breadcrumbs={["Vendor Payment", "Accounts Team Bill Approval", isEdit ? "Edit" : "Add"]}
      />
        ...
        <form onSubmit={handleSubmit}>
          <HorizontalFormBody className="space-y-6">
            <p className="max-w-2xl text-[13px] leading-6 text-ink-secondary">
              Maintain accounts team bill approval settings in the same refreshed vendor form layout.
            </p>
