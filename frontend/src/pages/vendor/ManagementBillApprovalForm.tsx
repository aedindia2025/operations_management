...
export default function ManagementBillApprovalForm() {
  ...
  return (
    <div className="p-6">
      <PageTopbar
        title={isEdit ? "Edit Management Approval" : "Add Management Approval"}
        breadcrumbs={["Vendor Payment", "Management Team Bill Approval", isEdit ? "Edit" : "Add"]}
      />
        ...
        <form onSubmit={handleSubmit}>
          <HorizontalFormBody className="space-y-6">
            <p className="max-w-2xl text-[13px] leading-6 text-ink-secondary">
              Maintain management approval settings in the same clean vendor form shell as the rest of the refreshed workflow.
            </p>
